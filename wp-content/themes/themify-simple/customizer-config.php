...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'mobile_menu_link_color' => array(
			...
			'selector' => '.mobile_menu_active #headerwrap .sidemenu-on a, .mobile_menu_active #headerwrap .sidemenu-on #main-nav a, .mobile_menu_active #headerwrap .sidemenu-on #main-nav ul a',
			'prop' => 'color',
		),
		'mobile_menu_link_hover_background' => array(
			...
			'selector' => '.mobile_menu_active #headerwrap .sidemenu-on a:hover, .mobile_menu_active #headerwrap .sidemenu-on #main-nav a:hover, .mobile_menu_active #headerwrap .sidemenu-on #main-nav ul a:hover, .mobile_menu_active #headerwrap .sidemenu-on #main-nav .current-menu-item > a',
			'prop' => 'background',
		),
