'use strict';(function(n,c){function l(a){try{a=c.parseJSON(a)}catch(b){a={}}return a}function v(a){a=a.prev("li");return 0<a.length&&0===a.children(".themify-control-title").length?v(a):a.index()}"use strict";n=document.createElement("script");var w=document.getElementsByTagName("script")[0];n.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js";n.type="text/javascript";n.async="true";w.parentNode.insertBefore(n,w);var e=wp.customize,
...
a=c(this).closest("li").find(".themify-control-sub-accordeon");c(this).hasClass("topen")?(c(this).removeClass("topen"),a.slideUp()):(c(this).addClass("topen"),a.slideDown())}),c(".themify-control-sub-accordeon").hide(),c("body").on("mouseover",".devices [data-device]",function(a){a=""+c(this).data("device").replace("_"," ");c(this).append('<span class="themify_customize_tooltip">'+a+"</span>")}).on("mouseout",".devices [data-device]",function(a){c(this).children(".themify_customize_tooltip").remove()}),
...
multiple:!1});d.on("select",function(){var f=d.state().get("selection").first().toJSON(),g=c('<a href="#" class="remove-image tf_close"></a><img src="'+f.url+'" />').css("display","inline-block"),e=c(".themify_control_preview",a.container),k=c("a",e),l=c("img",e);a.isResponsiveStyling()?(_.isUndefined(a.value[a.id][a.getCurrentDevice()])&&(a.value[a.id][a.getCurrentDevice()]={}),a.value[a.id][a.getCurrentDevice()].id=f.id,a.value[a.id][a.getCurrentDevice()].src=f.url):(a.value[a.id].id=f.id,a.value[a.id].src=
f.url);b.val(JSON.stringify(a.value[a.id])).trigger("change");0<k.length&&k.remove();0<l.length&&l.remove();e.append(g).fadeIn()});d.open()});c(".open-media-wrap",a.container).on("click",".remove-image",function(d){d.preventDefault();a.isResponsiveStyling()?(_.isUndefined(a.value[a.id][a.getCurrentDevice()])&&(a.value[a.id][a.getCurrentDevice()]={}),a.value[a.id][a.getCurrentDevice()].id="",a.value[a.id][a.getCurrentDevice()].src=""):(a.value[a.id].id="",a.value[a.id].src="");b.val(JSON.stringify(a.value[a.id])).trigger("change");
...
e=0<a.length?c(this).find("option:selected").data("variants"):!1;b.isResponsiveStyling()?(_.isUndefined(b.value[b.id][b.getCurrentDevice()])&&(b.value[b.id][b.getCurrentDevice()]={}),b.value[b.id][b.getCurrentDevice()].family=l(c("option:selected",c(this)).val())):b.value[b.id].family=l(c("option:selected",c(this)).val());if(e){a.closest(".themify-customizer-brick").show();e=c.trim(e).split(",");a.find("option").each(function(){-1===c.inArray(c(this).val(),e)?c(this).hide():c(this).show()});var g=
a.find("option:selected");g.is(":visible")||(g.prop("selected",!1),a.find("option").each(function(){if("none"!=c(this).css("display"))return c(this).prop("selected",!0).trigger("change"),!1}))}else"string"===typeof e?a.val("").find("option").hide().closest(".themify-customizer-brick").hide():a.find("option").show().closest(".themify-customizer-brick").show();d.val(JSON.stringify(b.value[b.id])).trigger("change");c("#themify_font_preview").hide()},focusin:function(){var a=c(this).data("selected");
if(0<c(".themify_add_fonts").length){var d=c(".themify_add_fonts").html();d=c(d);d.find("option").removeAttr("selected");a&&d.find('option[data-value="'+a+'"]').attr("selected","selected");c(this).html(d)}else{c("body").append('<span id="themify_font_preview"><span class="themify_font_wait"></span>Font Preview</span>');var e=l(decodeURI(c("#themify_fonts_hidden").val())),m=e.cf,k=e.google,n=e.fonts;d="";e=null;if(0<m.length){for(var p in m){e=m[p].name;var u=m[p].value,q='{"fonttype":"cf","name":"'+
u+'"}';r=a&&a==u?'selected="selected"':"";e=b.escapeHtml(e);d+="<option data-variants='"+m[p].variants+"' data-value='"+u+"' class='cf_font' "+r+"  value='"+q+"'>"+e+"</option>"}m=null;c(this).children("optgroup").first().html(d);d=""}for(p in n){e=n[p].value;var r=a&&a==e?'selected="selected"':"";e=b.escapeHtml(e);q='{"fonttype":"websafe","name":"'+e+'"}';d+="<option "+r+" data-value='"+e+"' value='"+q+"'>"+n[p].name+"</option>"}n=null;c(this).children("optgroup.themify_wsf_optgroup").html(d);d=
"";for(p in k)e=k[p].name,r=a&&a==e?'selected="selected"':"",q='{"fonttype":"google"',e=b.escapeHtml(e),q+=',"name":"'+e+'"}',d+="<option data-variants='"+k[p].variants+"' data-value='"+e+"' class='google_font' "+r+"  value='"+q+"'>"+k[p].name+"</option>";k=null;c(this).children("optgroup").last().html(d);c(this).addClass("themify_add_fonts");c("#themify_fonts_hidden").remove();b.fontHover()}var t=c(this);t.off("focusin").scombobox({wrap:!0,reassignId:!1,empty:a?!1:!0,showDropDown:!0,beforeClose:function(){c("#themify_font_preview").hide()},
afterClose:function(){var a=t.closest(".scombobox").find(".scombobox-display");c.trim(a.val())||t.data("selected","").find("option:selected").prop("selected",!1).trigger("change");c("#themify_font_preview").is(":visible")&&!t.find(".scombobox-list").is(":visible")&&c("#themify_font_preview").hide()}})}})},escapeHtml:function(a){var b={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return a.replace(/[&<>"']/g,function(a){return b[a]})},fontHover:function(){c(".themify_combobox").delegate(".scombobox-list p",
"mouseover",function(a){a.stopImmediatePropagation();var b=c("#themify_font_preview");if(c(this).data("value")&&c(this).is(":visible")){a=l(c(this).data("value"));var d=c(this).offset();b.css({top:d.top-7,left:d.left+260});"google"!==a.fonttype&&"cf"!==a.fonttype||c(this).hasClass("themify_font_loaded")?b.css("font-family",a.name).removeClass("themify_show_wait").show():(c(".themify_combobox .scombobox-list p").removeClass("current"),c(this).addClass("current"),b.addClass("themify_show_wait"),setTimeout(function(){var a=
c(".themify_combobox p.current");if(a.closest(".scombobox-list").is(":visible")){var d=l(a.data("value")),e=a.offset(),m={fontloading:function(c,d){b.css("font-family",c).removeClass("themify_show_wait");a.addClass("themify_font_loaded")}};b.css({top:e.top-7,left:e.left+260}).show();"google"===d.fonttype?m.google={families:[d.name]}:m.custom={families:[d.name],urls:[themifyCustomizerControls.cf_api_url+d.name]};WebFont.load(m)}else b.hide()},800))}else b.hide()})},inputOption:function(a,b){var d=
this,e=c(d.field,d.container),h;a.on("keyup",function(){var a=c(this).val();"blogname"===b&&c(".customize-control-themify_logo").find(".site-name").each(function(){c(this).val(a)});clearTimeout(h);h=setTimeout(function(){c.post(ajaxurl,{action:"themify_customizer_save_option",option:b,value:a,nonce:themifyCustomizerControls.nonce},function(a){"saved"===a&&(d.value[d.id].stamp=(new Date).getTime(),e.val(JSON.stringify(d.value[d.id])).trigger("change"))})},750)})},saveOption:function(a,b){var d=this;
...
c(a+"-mode-wrap",b.container).hide();c(a+"-"+c('input[type="radio"]'+a+"-mode:checked").val()+"-mode",b.container).show()},addQueryArg:function(a,b,c){c=c||window.location.href;var d,e=new RegExp("([?&])"+a+"=.*?(&|#|$)(.*)","gi");return e.test(c)?"undefined"!==typeof b&&null!==b?c.replace(e,"$1"+a+"="+b+"$2$3"):(d=c.split("#"),c=d[0].replace(e,"$1$3").replace(/(&|\?)$/,""),"undefined"!==typeof d[1]&&null!==d[1]&&(c+="#"+d[1]),c):"undefined"!==typeof b&&null!==b?(e=-1!==c.indexOf("?")?"&":"?",d=c.split("#"),
c=d[0]+e+a+"="+b,"undefined"!==typeof d[1]&&null!==d[1]&&(c+="#"+d[1]),c):c},getParameterByName:function(a,b){b||(b=window.location.href);a=a.replace(/[\[\]]/g,"\\$&");return(a=(new RegExp("[?&]"+a+"(=([^&#]*)|&|#|$)")).exec(b))?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":null},isResponsiveStyling:function(){return"desktop"!==e.previewedDevice.get()},getCurrentDevice:function(){return e.previewedDevice.get()},radioChange:function(a,b){var d=this,e=c(d.field,d.container),h=a.find('input[type="radio"]:checked').val();
a.find('input[type="radio"]').on("click",function(){var f=c(this).val();d.isResponsiveStyling()?(_.isUndefined(d.value[d.id][d.getCurrentDevice()])&&(d.value[d.id][d.getCurrentDevice()]={}),d.value[d.id][d.getCurrentDevice()][b]=f):(d.value[d.id][b]=f,a.closest(".customize-control").data("deskValue",f));a.nextAll('[class*="-mode-wrap"]').hide();a.nextAll('[class*="-'+f+'-mode"]').show();e.val(JSON.stringify(d.value[d.id])).trigger("change")});a.nextAll('[class*="-mode-wrap"]').hide();a.nextAll('[class*="-'+
h+'-mode"]').show()}});e.ThemifyFont=e.ThemifyControl.extend({field:".themify_font_control",ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.collapse(c(".disable-control",this.container));this.fontFamily(c(".themify_font_family",this.container));this.input(c(".font_size_num",this.container),"sizenum");this.dropdown(c(".font_size_unit",this.container),"sizeunit");this.input(c(".letter_spacing",this.container),"letterspacing");this.dropdown(c(".letter_spacing_unit",
this.container),"letterspacingunit");this.input(c(".font_line_num",this.container),"linenum");this.dropdown(c(".font_line_unit",this.container),"lineunit");this.dropdown(c(".font_weight_select",this.container),"weight");this.fontStyle(c(".themify_font_style",this.container));this.textTransform(c(".themify_text_transform",this.container));this.textAlign(c(".themify_font_align",this.container))}});e.controlConstructor.themify_font=e.ThemifyFont;e.controlConstructor.themify_text_decoration=e.ThemifyFont;
e.ThemifyLogo=e.ThemifyControl.extend({field:".themify_logo_control",ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.inputOption(c(".site-name",this.container),"blogname");this.input(c(".site-link",this.container),"link");this.openMedia();this.input(c(".img-width",this.container),"imgwidth");this.input(c(".img-height",this.container),"imgheight");this.collapse(c(".disable-control",this.container));this.fontFamily(c(".themify_font_family",this.container));
this.input(c(".font_size_num",this.container),"sizenum");this.dropdown(c(".font_size_unit",this.container),"sizeunit");this.input(c(".font_line_num",this.container),"linenum");this.dropdown(c(".font_line_unit",this.container),"lineunit");this.input(c(".letter_spacing",this.container),"letterspacing");this.dropdown(c(".letter_spacing_unit",this.container),"letterspacingunit");this.dropdown(c(".font_weight_select",this.container),"weight");this.fontStyle(c(".themify_font_style",this.container));this.textTransform(c(".themify_text_transform",
this.container));this.textAlign(c(".themify_font_align",this.container));this.pickColor();this.radioChange(c(".logo-modes",this.container),"mode")}});e.controlConstructor.themify_logo=e.ThemifyLogo;e.ThemifyTagline=e.ThemifyControl.extend({field:".themify_tagline_control",ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.changeMode(".tagline");this.inputOption(c(".site-description",this.container),"blogdescription");this.openMedia();this.input(c(".img-width",
this.container),"imgwidth");this.input(c(".img-height",this.container),"imgheight");this.collapse(c(".disable-control",this.container));this.fontFamily(c(".themify_font_family",this.container));this.input(c(".font_size_num",this.container),"sizenum");this.dropdown(c(".font_size_unit",this.container),"sizeunit");this.input(c(".letter_spacing",this.container),"letterspacing");this.dropdown(c(".letter_spacing_unit",this.container),"letterspacingunit");this.input(c(".font_line_num",this.container),"linenum");
this.dropdown(c(".font_line_unit",this.container),"lineunit");this.dropdown(c(".font_weight_select",this.container),"weight");this.fontStyle(c(".themify_font_style",this.container));this.textTransform(c(".themify_text_transform",this.container));this.textAlign(c(".themify_font_align",this.container));this.pickColor();this.input(c(".site-description-link",this.container),"link")}});e.controlConstructor.themify_tagline=e.ThemifyTagline;e.ThemifyBackground=e.ThemifyControl.extend({field:".themify_background_control",
noImage:function(a){var b=this,d=c(b.field,b.container),e=c(".open-media-wrap, .image-label, .background-style, .background-position",b.container);a.on("click",function(){c(this).prop("checked")?(b.isResponsiveStyling()?(_.isUndefined(b.value[b.id][b.getCurrentDevice()])&&(b.value[b.id][b.getCurrentDevice()]={}),b.value[b.id][b.getCurrentDevice()].noimage="noimage"):b.value[b.id].noimage="noimage",e.stop().slideUp()):(b.isResponsiveStyling()?(_.isUndefined(b.value[b.id][b.getCurrentDevice()])&&(b.value[b.id][b.getCurrentDevice()]=
...
(_.isUndefined(b.value[b.id][b.getCurrentDevice()])&&(b.value[b.id][b.getCurrentDevice()]={}),b.value[b.id][b.getCurrentDevice()].fixedbg=""):b.value[b.id].fixedbg="";d.val(JSON.stringify(b.value[b.id])).trigger("change")})},ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.noImage(c(".disable-control",this.container));this.fixedBg(c('.fixed-bg input[type="checkbox"]',this.container));this.openMedia();this.dropdown(c(".image-style",this.container),
"style");this.dropdown(c(".position-style",this.container),"position");this.pickColor();this.transparent(c(".color-transparent",this.container))}});e.controlConstructor.themify_background=e.ThemifyBackground;e.ThemifyColor=e.ThemifyControl.extend({field:".themify_color_control",ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.pickColor();this.transparent(c(".color-transparent",this.container))}});e.controlConstructor.themify_color=e.ThemifyColor;e.ThemifyImage=
e.ThemifyBackground.extend({field:".themify_image_control",ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{};this.input(c(".img-width",this.container),"imgwidth");this.input(c(".img-height",this.container),"imgheight");this.openMedia()}});e.controlConstructor.themify_image=e.ThemifyImage;e.ThemifyBorder=e.ThemifyControl.extend({field:".themify_border_control",ready:function(){var a=c(this.field,this.container);a.val()?this.value[this.id]=l(a.val()):(a={color:"",
...
ready:function(){var a=c(this.field,this.container);a.val()?this.value[this.id]=l(a.val()):(a={width:"",unit:"px"},this.value[this.id]={},this.value[this.id].top=a,this.value[this.id].left=a,this.value[this.id].bottom=a,this.value[this.id].right=a);this.collapse(c(".disable-control",this.container));this.dimensionSame(c(".dimension-width",this.container));this.dropdownSame(c(".dimension-unit",this.container),"unit");this.autoSame(c(".auto-prop",this.container));this.hideComponentsSame(c(".same",this.container))}});
e.controlConstructor.themify_margin=e.ThemifyMargin;e.ThemifyPadding=e.ThemifyMargin.extend({field:".themify_padding_control"});e.controlConstructor.themify_padding=e.ThemifyPadding;e.ThemifyWidth=e.ThemifyControl.extend({field:".themify_width_control",ready:function(){var a=c(this.field,this.container);a.val()?this.value[this.id]=l(a.val()):this.value[this.id]={width:"",unit:"px",auto:""};this.dimension(c(".dimension-width",this.container));this.dropdown(c(".dimension-unit",this.container),"unit");
...
f&&"static"!==f?a.closest(".themify-customizer-brick").parent().find(".position-wrap").show():a.closest(".themify-customizer-brick").parent().find(".position-wrap").hide()});h&&"static"!==h?a.closest(".themify-customizer-brick").parent().find(".position-wrap").show():a.closest(".themify-customizer-brick").parent().find(".position-wrap").hide()},ready:function(){var a=c(this.field,this.container);this.value[this.id]=a.val()?l(a.val()):{position:""};this.dropdownPosition(c(".position",this.container),
...
b.editor.codemirror.on("change",function(a){b.container.find("textarea").val(a.getValue()).trigger("change")});b.editor.codemirror.on("keydown",function(a,b){27==b.keyCode&&b.stopPropagation()})}}});e.controlConstructor.themify_customcss=e.ThemifyCustomCSS;e.ThemifyImageSelect=e.ThemifyControl.extend({field:".themify_image_select_control",ready:function(){var a=this,b=c(a.field,a.container);b.val()?a.value[a.id]=l(b.val()):a.value[a.id]={type:"",selected:""};c(".image-select",a.container).on("click",
