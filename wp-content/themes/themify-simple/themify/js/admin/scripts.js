		...
		if( previewIcon.length ) {		
			previewIcon.each( function() {		
                ...
                if(wp && wp.codeEditor && themify_js_vars.code_editor){
                    const editors = document.getElementsByClassName('tf_code_editor'),
                    ed_settings=themify_js_vars.code_editor;
                    for(let i=editors.length-1;i>-1;--i){
                        let ed = wp.codeEditor.initialize( editors[i],ed_settings);
