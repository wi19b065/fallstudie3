...
!0===f())d&&this.loadExtra(d),c&&c();else{!0===this.is_min&&-1===a.indexOf(".min.js")&&-1!==a.indexOf(g.location.hostname)&&(a=a.replace(".js",".min.js"));b||!1===b||(b=themify_vars.version);f=k.createElement("script");var m=this;f.setAttribute("id",e);!1!==h&&(h="async");f.setAttribute("async",h);b&&(a+="?ver="+b);f.onload=function(){c&&c();const a=this.getAttribute("id");if(m.jsCallbacks[a]){for(let b=0,c=m.jsCallbacks[a].length;b<c;++b)m.jsCallbacks[a][b]();delete m.jsCallbacks[a]}};k.head.appendChild(f);
f.setAttribute("src",a);d&&this.loadExtra(d,f)}},loadExtra(a,c,b,d){if(a){if("string"===typeof c&&(c=k.querySelector("script#"+c),null===c))return;let h="";if(c&&a.before){if("string"!==typeof a.before)for(var f in a.before)a.before[f]&&(h+=a.before[f]);else h=a.before;""!==h&&(f=k.createElement("script"),f.type="text/javascript",f.text=h,c.parentNode.insertBefore(f,c))}if("string"!==typeof a){h="";for(let b in a)"before"!==b&&a[b]&&(h+=a[b])}else h=a;""!==h&&(a=k.createElement("script"),a.type="text/javascript",
a.text=h,void 0===b||!0===b?k.head.appendChild(a):k.body.appendChild(a),d&&d())}},LoadCss(a,c,b,d,f){c||!1===c||(c=themify_vars.version);const h=this.hash(a);c=c?a+"?ver="+c:a;!0===this.is_min&&-1===a.indexOf(".min.css")&&-1!==a.indexOf(g.location.hostname)&&(c=c.replace(".css",".min.css"));if(!0!==this.cssLazy[h])this.cssLazy[h]=!0;else return f&&(b=k.getElementById(h),null!==b&&"only_x"!==b.getAttribute("media")?f():(this.cssCallbacks[h]||(this.cssCallbacks[h]=[]),this.cssCallbacks[h].push(f))),
!1;d||(d="all");a=k.createElement("link");const e=b?b:k.head.firstElementChild,l=this,m=function(){this.setAttribute("media",d);const a=this.getAttribute("id"),b=function(){const c=k.styleSheets;let d=!1;for(let b=c.length-1;-1<b;--b)if(c[b].ownerNode.id===a){d=!0;break}if(!0===d){if(f&&f(),l.cssCallbacks[a]){for(let b=0,c=l.cssCallbacks[a].length;b<c;++b)l.cssCallbacks[a][b]();delete l.cssCallbacks[a]}}else setTimeout(b,80)};(f||void 0!==l.cssCallbacks[a])&&b()};if(-1===c.indexOf("http")){const a=
k.createElement("a");a.href=c;c=a.href}a.setAttribute("href",c);a.setAttribute("rel","stylesheet");a.setAttribute("importance","low");a.setAttribute("media","only_x");a.setAttribute("id",h);if("isApplicationInstalled"in navigator)a.onloadcssdefined(m);else a.addEventListener("load",m,{passive:!0,once:!0});e.parentNode.insertBefore(a,b?e:e.nextSibling)},InitGallery(){var a=!1===this.is_builder_active&&themify_vars.lightbox?themify_vars.lightbox:!1;if(!1!==a&&!1!==a.lightboxOn&&!this.jsLazy.tf_gallery_init){this.jsLazy.tf_gallery_init=
!0;const c=this,b=g.location.hash.replace("#",""),d=c.body.parent(),f={extraLightboxArgs:themify_vars.extraLightboxArgs,lightboxSelector:a.lightboxSelector?a.lightboxSelector:".themify_lightbox",gallerySelector:a.gallerySelector?a.gallerySelector:".gallery-item a",contentImagesAreas:a.contentImagesAreas};let h=!1;const e=function(a){return a.match(/\.(gif|jpg|jpeg|tiff|png|webp|apng)(\?fit=\d+(,|%2C)\d+)?(&ssl=\d+)?$/i)},l=function(a){a.preventDefault();a.stopImmediatePropagation();if(!0!==h){h=!0;
var b=n(a.currentTarget);a=b[0].getAttribute("href");var l=k.createElement("div"),g=k.createElement("div"),m=function(){!0===c.cssLazy.tf_lightbox&&!0===c.jsLazy.tf_lightbox&&!0===c.jsLazy.tf_gallery&&(d.off("click.tf_gallery"),c.trigger("tf_gallery_init",f),b.click(),l.remove())};l.className="tf_lazy_lightbox tf_w tf_h";a&&e(a)?(l.textContent="Loading...",g=new Image,g.decoding="async",g.src=a):(g.className="tf_lazy tf_w tf_h",l.appendChild(g));c.body[0].appendChild(l);c.cssLazy.tf_lightbox||c.LoadCss(c.css_modules.lb,
null,null,null,function(){c.cssLazy.tf_lightbox=!0;m()});c.jsLazy.tf_lightbox||c.LoadAsync(c.js_modules.lb,function(){c.jsLazy.tf_lightbox=!0;m()},"1.1.0",null,function(){return"undefined"!==typeof n.fn.magnificPopup});c.jsLazy.tf_gallery||c.LoadAsync(c.js_modules.gal,function(){c.jsLazy.tf_gallery=!0;m()},null,null,function(){return!!c.jsLazy.tf_gallery});m()}};d.on("click.tf_gallery",f.lightboxSelector,l);if(f.gallerySelector)d.on("click.tf_gallery",f.gallerySelector,function(a){e(this.getAttribute("href"))&&
l(a)});if(a.contentImagesAreas)d.on("click.tf_gallery",".post-content a",function(a){e(this.getAttribute("href"))&&n(this).closest(f.contentImagesAreas)&&l(a)});b&&"#"!==b&&(a=k.querySelector('img[alt="'+decodeURI(b)+'"]'))&&(a=a.closest(".themify_lightbox"))&&a.click()}},parseVideo(a){a=a.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/i);return{type:null!==a?-1<a[3].indexOf("youtu")?"youtube":
-1<a[3].indexOf("vimeo")?"vimeo":!1:!1,id:null!==a?a[6]:!1}},hash(a){let c=0;for(let b=a.length-1;-1<b;--b)c=(c<<5)-c+a.charCodeAt(b),c&=c;return c},scrollTo(a,c,b,d){c||(c=800);a||(a=0);const f=n("html,body"),h="smooth"===f.css("scroll-behavior");h&&f.css("scroll-behavior","auto");f.stop().animate({scrollTop:a},{progress:d,duration:c,done:function(){h&&f.css("scroll-behavior","");b&&b()}})},imagesLoad(a,c){const b=function(a,b){b||"function"!==typeof a?null!==a?a instanceof jQuery?a.imagesLoaded().always(b):
imagesLoaded(a,b):"function"===typeof b&&b():a()};g.imagesLoaded?b(a,c):this.LoadAsync(this.js_modules.img,b.bind(null,a,c),themify_vars.i_v,null,function(){return!!g.imagesLoaded})},autoTiles(a,c){if(a&&0!==a.length)if(this.jsLazy.tf_autotiles)this.trigger("tf_autotiles_init",[a,c]);else{const b=this;this.LoadAsync(this.js_modules.at,function(){b.jsLazy.tf_autotiles=!0;b.trigger("tf_autotiles_init",[a,c])},null,null,function(){return!!b.jsLazy.tf_autotiles})}},isoTop(a,c){if("string"!==typeof a){a instanceof
...
h=function(a){const b=a instanceof jQuery?a:this;a.target&&!b[0].parentNode.contains(a.target)?(b.css("display",""),b[0].parentNode.classList.remove("toggle-on")):k.addEventListener("touchstart",h.bind(b),{once:!0})};if(!c&&!themify_vars.disableMega&&a.getElementsByClassName("mega-link")[0]){const c=function(){const c=function(){!0===b.cssLazy.tf_megamenu&&!0===b.jsLazy.tf_megamenu&&b.trigger("tf_mega_menu",[a,d])};b.cssLazy.tf_megamenu||b.LoadCss(b.css_modules.mega,null,null,"screen and (min-width:"+
d+"px)",function(){b.cssLazy.tf_megamenu=!0;c()});b.jsLazy.tf_megamenu||b.LoadAsync(b.js_modules.mega,function(){b.jsLazy.tf_megamenu=!0;c()});c()};if(this.w>=d||!this.isTouch)c();else if(this.isTouch){const a=function(){const b="undefined"!==typeof this.screen&&"undefined"!==typeof this.screen.orientation?this.screen.orientation.angle:this.orientation;(90===b||-90===b?this.innerHeight:this.innerWidth)>=d&&(this.removeEventListener("orientationchange",a,{passive:!0}),c())};g.addEventListener("orientationchange",
