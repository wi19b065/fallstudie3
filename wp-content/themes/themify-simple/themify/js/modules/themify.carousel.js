                ...
                for (let i = items.length - 1; i > -1; --i) {
                    if (!items[i].classList.contains('swiper-process') && !items[i].classList.contains('swiper-container-initialized')) {
                        ...
                        self.imagesLoad(items[i], function (instance) {
                            ...
                            if (data['effect'] && data['effect'] !== 'scroll' && (data['effect'] === 'fade' || data['effect'] === 'crossfade' || data['effect'] === 'flip' || data['effect'] === 'cube' || data['effect'] === 'coverflow')) {
                                if (data['effect'] === 'crossfade') {
                                    args['effect'] = 'fade';
                                    args['fadeEffect'] = {
                                        crossFade: true
                                    };
