    ...
    const ThemifyGallery = {
        ...
        lightboxSelector(e) {
            ...
            const self=ThemifyGallery, 
                ...
                $groupItems = type === 'inline' || type === 'iframe' ? [] : ($self.data('rel') ? $('a[data-rel="' + $self.data('rel') + '"]') : $self.closest('.module_row, .loops-wrapper, .gallery-wrapper').find('.themify_lightbox img').parents('.themify_lightbox')),
                patterns = {};
            let targetItems,
