...
b?a.substr(0,b):a);return c},stripHtml(a){const b=q.createElement("div");b.innerHTML=a;return b.textContent||b.innerText||""},setData(a){c.Utils.clearElementId([a]);a=c.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview(){h(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt())},getPreviewSettings(){return _.extend({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults)},getIDattr(){return this.get("element_id")?this.get("element_id"):c.Utils.generateUniqueID()}});
...
p=function(a){if(-1!==a.indexOf("breakpoint_")||-1!==a.indexOf("_apply_all"))return!0;var b=-1!==a.indexOf("_color")?"color":-1!==a.indexOf("_style")?"style":!1;if(!1!==b){if(b=a.replace("_"+b,"_width"),l[b]!==n&&"border"===l[b].type)return!0}else if(-1!==a.indexOf("_unit")){if(b=a.replace(/_unit$/ig,"",""),l[b]!==n)return!0}else if(-1!==a.indexOf("_w")){if(b=a.replace(/_w$/ig,"",""),l[b]!==n&&"font_select"===l[b].type)return!0}else if(l[a]!==n&&"radio"===l[a].type)return!0;return!1};h[d]===n&&(h[d]=
{});for(var u in b[d])l[u]!==n||p(u)?(h[d][u]=b[d][u],l[u]!==n&&(!0===l[u].isFontColor&&b[d][l[u].g+"-gradient"]!==n?h[d][l[u].g+"-gradient"]=b[d][l[u].g+"-gradient"]:(l[u].posId!==n&&b[d][l[u].posId]!==n&&(h[d][l[u].posId]=b[d][l[u].posId]),l[u].repeatId!==n&&b[d][l[u].repeatId]!==n&&(h[d][l[u].repeatId]=b[d][l[u].repeatId])))):delete b[d][u];b.used_gs!==n&&(h.used_gs=b.used_gs);l=null;b=h;delete b.element_id}"column"===f&&(b.grid_class=c.Utils.filterClass(a.prop("class")),a.hasClass("first")?b.grid_class+=
" first":a.hasClass("last")&&(b.grid_class+=" last"),u=a[0].style.width,b.grid_width=u?u.replace("%",""):null,b.component_name=e.get("component_name"));!1===k&&c.Utils.clearElementId([b]);c.hasChanged=!0;!1===k&&"module"===f&&"column"===e.get("elType")&&(e=c.Views.init_module({mod_name:g},!0),f=e.view.render().$el,a[0].getElementsByClassName("tb_holder")[0].appendChild(f[0]),e=e.model,a=f);c.beforeEvent=m.clone(a);e.setData(b);null!==c.activeModel&&m.Lightbox.close()}},importExport(a,b){const d=b.classList.contains("tb_import")?
...
b?"row":"subrow").cols[a.index()]}return c.Utils.clear(d)},duplicate(a,b){a=this.$el;b=m.clone(a);null!==c.activeModel&&m.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent();a.removeClass("tb_element_cid_"+this.model.cid);b.hide().insertAfter(a);var d=this.getData(b,this.model.get("elType"));c.eventName="duplicate";c.beforeEvent=b;c.hasChanged=!0;this.model.setData(d);a.addClass("tb_element_cid_"+this.model.cid)},edit(a,b){if(c.isPreview)return!0;"breadcrumb"!==a?c.ActionBar.breadCrumbsPath.lightbox=
null:a=null;let d=c.hasChanged=!1,e=m.Lightbox.$lightbox,f=this.model.get("elType"),g=!1,k="module"===f?this.model.get("mod_name"):f,l=!1;if(null!==a){const e=b.classList;let p=e.contains("tb_dragger")?b.getAttribute("data-id"):null;if(null!==p&&""===b.getAttribute("data-v"))return;"dblclick"===a.type&&this.model.cid!==c.autoSaveCid&&c.ActionBar.clear();l=null!==p||e.contains("tb_styling");if(!0===l)this.model.set({styleClicked:!0},{silent:!0}),null!==p&&(g=function(a){var b=e.contains("tb_dragger_padding")?
"padding":"margin",d="padding"===b?"p":"m";const g=ThemifyConstructor.label[d];let l=n;if("module"===f){let e;l=a.getElementsByClassName("tb_styling_tab_nav")[0];if(l!==n){if(c.EdgeDrag.modules[k]!==n&&c.EdgeDrag.modules[k][b]!==n&&(p=p.replace(/_left|_right|_bottom|_top$/ig,""),c.EdgeDrag.modules[k][b][p]!==n&&(e=c.EdgeDrag.getTabId(ThemifyConstructor.data[k].styling.options.options,p,d),null!==e))){b=l.getElementsByClassName("tb_tab_wrapper")[0].getElementsByTagName("a");for(d=b.length-1;-1<d;--d)if(b[d].getAttribute("href")===
"#tb_1_"+e){b[d].click();break}b=null}e=l.getElementsByClassName("current")[0].getElementsByTagName("a")[0].getAttribute("href");l=a.querySelector(e)}}l===n&&(l=a);const u=l.getElementsByClassName("tb_style_toggle");for(let a=u.length-1;-1<a;--a)if(u[a].textContent===g){u[a].classList.contains("tb_closed")&&u[a].click();setTimeout(function(){h("#tb_lightbox_container").scrollTop(u[a].offsetTop)},10);break}});else if(e.contains("tb_visibility_component"))d=!0,this.model.set({visibileClicked:!0},{silent:!0});
...
m.Lightbox.$lightbox[0].getElementsByClassName("tb_action_breadcrumb")[0].appendChild(c.ActionBar.getBreadCrumbs(c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.model.cid)[0])))},delete(a,b,d){a=this.$el;b=this.model;var e=b.cid,f=b.get("elType");if(!0===d||confirm(themifyBuilder.i18n[f+"DeleteConfirm"])){null!==c.activeModel&&c.activeModel.cid===e&&m.Lightbox.$lightbox.find(".tb_close_lightbox")[0].click();d=a.closest(".module_row");var g="row",k="",l={};"row"===
f?(l.pos_cid=d.next(".module_row"),l.pos="before",0===l.pos_cid.length&&(l.pos="after",l.pos_cid=d.prev(".module_row")),g="delete_row",l.pos_cid=l.pos_cid.data("cid")):e=d.data("cid");d=m.clone(d);if("row"!==f)var t=a.closest(".module_subrow");b.destroy();"row"!==f&&0<t.length&&0===t.find(".active_module").length&&t.addClass("tb_row_empty");"row"!==f&&(k=h(".tb_element_cid_"+e),t=k.closest(".module_row"),0===t.find(".active_module").length&&t.addClass("tb_row_empty"));c.hasChanged=!0;c.undoManager.push(e,
...
n?this.id:null;c||(c=b);a=("tb_toolbar"===c||"wpadminbar"===c?"-":"+")+("="+g*t+"px");f.stop().animate({scrollTop:a},{duration:1,complete(){!0===l&&(10>t&&++t,k=null,d(null,c))}})}}var e=h("body",r.document);"visual"===c.mode&&(e=e.add(v.body));this.top===n&&(this.top=c.toolbar.$el,this.top=this.top.add(h("#tb_fixed_bottom_scroll",r.document)),"visual"!==c.mode&&(this.top=this.top.add("#wpadminbar")));if(!0===b)this.top.off("mouseenter mouseleave"),"row"===a&&"visual"===c.mode&&c.toolbar.$el.find('.tb_zoom[data-zoom="100"]').trigger("click"),
e.removeClass("tb_drag_start tb_drag_"+a);else{var f=null,g=1,k=null,l=!0,t=1;"visual"!==c.mode&&(f=h(".edit-post-layout__content").first(),0===f.length?f=null:g/=2);null===f&&(f="desktop"===c.activeBreakPoint?h("body,html"):h("body,html",r.document));e.addClass("tb_drag_start tb_drag_"+a);"row"===a&&"visual"===c.mode&&c.toolbar.$el.find('.tb_zoom[data-zoom="50"]').trigger("click");if(0<g)this.top.off("mouseenter").on("mouseenter",d).off("mouseleave").on("mouseleave",function(){t=1;k=l=null;f.stop()})}},
...
a.replaceWith(h.el);k?c.activeModel=l.model:l.model.trigger("edit",null);c.hasChanged=!0;let f=!1;if("visual"===c.mode&&"layout-part"!==l.model.get("mod_name")&&1<=Object.keys(e).length){var p=e.cid;"part"===g||"ajax"===a.data("type")?(f=!0,l.model.trigger("custom:preview:refresh",e)):"module"!==g?l.model.trigger("custom:preview:live",e):c.Utils.loadContentJs(h.$el,"module")}k&&(f&&(e=l.view.$el.find(".tb_preview_component").detach(),l.view.$el.prepend(e)),d&&(p=h.$el.closest(".module_row"),p.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),
h.$el.closest(".module_subrow").removeClass("tb_row_empty"),c.undoManager.push(p.data("cid"),d,p,"row"),p=p.data("cid"),c.Instances.Builder[c.builderIndex].removeLayoutButton(),c.activeModel=null),c.Utils.calculateHeight());c.Utils.scrollToDropped(null,p)}const l=c.Views.init_module(e,!0),h=l.view.render();"visual"===c.mode&&k?(e=[],e[l.model.cid]=1,c.bootstrap(e,f)):f(!0);return h}c.ActionBar.clear();if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var f={mod_name:a.data("module-slug")},
...
b.closest(".module_subrow").getElementsByClassName("tb_subrow_action")[0];f!==n&&(g=f.getBoundingClientRect(),g=Math.abs(e.left-g.left)<e.width?Math.abs(g.top-e.top)>e.height:!0);!0===g?d.classList.remove("tb_action_overlap"):d.classList.add("tb_action_overlap")}}!0!==this.isFullWidth&&(b=null!==b?b.parentNode.closest(".module_column"):a.closest(".module_column"),!1!==this.isFullWidth&&(a=null!==b?b.closest(".module_row"):a.closest(".module_row"),null!==a&&(a.offsetWidth<q.body.clientWidth?(this.isFullWidth=
!0,q.body.classList.remove("tb_page_row_fullwidth")):(this.isFullWidth=!1,q.body.classList.add("tb_page_row_fullwidth")))),null!==b&&null!==b.parentNode.parentNode.closest(".fullwidth")&&(a=b.getElementsByClassName("tb_column_action")[0],a!==n&&a.getBoundingClientRect().right>=q.body.clientWidth&&a.classList.add("tb_action_outside")))}};c.undoManager={stack:[],is_working:!1,index:-1,btnUndo:null,btnRedo:null,compactBtn:null,init(){this.btnUndo=c.toolbar.el.getElementsByClassName("tb_undo_btn")[0];
this.btnRedo=c.toolbar.el.getElementsByClassName("tb_redo_btn")[0];this.compactBtn=c.toolbar.el.getElementsByClassName("tb_compact_undo")[0];c.toolbar.$el.find(".tb_undo_redo").on("click",this.do_change.bind(this));if(!themifyBuilder.disableShortcuts&&(h(r.document).on("keydown",this.keypres.bind(this)),"visual"===c.mode))h(q).on("keydown",this.keypres.bind(this))},push(a,b,d,e,f){c.hasChanged&&(c.editing=!1,d&&(d=m.clone(d)),"visual"!==c.mode||"duplicate"!==e&&"sort"!==e||v.trigger("tfsmartresize"),
...
keypres(a){if(90===a.which&&"INPUT"!==q.activeElement.tagName&&"TEXTAREA"!==q.activeElement.tagName)if(!0===a.ctrlKey&&!0===a.shiftKey||!0===a.metaKey&&!0===a.shiftKey)a.preventDefault(),this.hasRedo()&&this.changes(!1);else if(!0===a.ctrlKey||!0===a.metaKey)a.preventDefault(),this.hasUndo()&&this.changes(!0)},changes(a){c.ActionBar.clearClicked();var b=a?0:1;if(null!==c.activeModel){if(!0===c.hasChanged){ThemifyConstructor.saveComponent(!1);h(this.btnUndo).triggerHandler("click");return}m.Lightbox.close()}var d=
...
"module"===e.get("elType"),t=l?"mod_settings":"styling";if(l&&d.data.column)a?(d=h(".tb_element_cid_"+g).closest(".module_row"),g=!1,this.doScroll(f).remove()):(g=d.data.column.data("cid"),b=m.clone(d.data.column),f=h(".tb_element_cid_"+g),this.doScroll(f),this.set(b),f.replaceWith(b),d=b.closest(".module_row")),d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null;else{this.doScroll(f);l={};a?(b=m.clone(d.before),l[t]=d.data.bsettings):(b=m.clone(d.after),l[t]=d.data.asettings);
if("visual"===c.mode){d=h.extend(!0,{},d.data.styles);for(var p in d){var u=ThemifyStyles.getSheet(p);u=u.cssRules?u.cssRules:u.rules;for(k in d[p])if(u[k])for(var w in d[p][k])u[k].style["backgroundClip"===w||"background-clip"===w?"WebkitBackgroundClip":w]=a?d[p][k][w].b:d[p][k][w].a}d=c.activeModel;k=l[t][c.GS.key]!==n?l[t][c.GS.key].split(" "):[];c.activeModel=e;c.GS.liveInstance=null;c.GS.generateValues(null,k,!0);c.activeModel=d;c.GS.liveInstance=null}e.set(l,{silent:!0});l=null;this.set(b);
f.replaceWith(b)}}else if("predesign"===e)if(f=d.data.rows,a)for(this.doScroll(h(".tb_element_cid_"+f[0].data("cid"))),k=0,e=f.length;k<e;++k)h(".tb_element_cid_"+f[k].data("cid")).remove();else{p=q.createDocumentFragment();b=[];k=0;for(e=f.length;k<e;++k)w=m.clone(f[k]),p.appendChild(w[0]),b.push(w);!1!==d.data.prev?this.doScroll(h(".tb_element_cid_"+d.data.prev)).after(p):this.doScroll("visual"===c.mode?h("#themify_builder_content-"+d.data.bid):h("#tb_row_wrapper")).prepend(p);k=0;for(e=b.length;k<
...
"click .tb_toolbar_builder_preview":"previewBuilder","click .js-tb_module_panel_acc":"toggleAccordion"},lightboxStorageKey:"tb_module_panel",render(){const a=this;var b={};for(var d in themifyBuilder.modules){var e=q.createElement("div"),f=q.createElement("div");let a=q.createElement("span"),k=q.createElement("strong"),l=q.createElement("a"),h=themifyBuilder.modules[d].icon;e.className="tb_module_outer tb-module-"+d;e.dataset.categories=themifyBuilder.modules[d].category;themifyBuilder.modules[d].favorite&&
...
h)));f.appendChild(a);f.appendChild(k);f.appendChild(l);e.appendChild(f);f=themifyBuilder.modules[d].favorite?["favorite"]:themifyBuilder.modules[d].category;for(let a=0,c=f.length;a<c;++a)b[f[a]]===n&&(b[f[a]]=q.createDocumentFragment()),b[f[a]].appendChild(e.cloneNode(!0))}d=this.el.getElementsByClassName("tb_module_category_content");for(e=d.length-1;-1<e;--e)if(f=d[e].getAttribute("data-category"))n!==b[f]?d[e].appendChild(b[f]):d[e].parentNode.style.display="none";"visual"===c.mode&&r.document.body.appendChild(this.el);
...
b=this,c,e,f,g,k=a.getElementsByClassName("tb_resizable"),l,t,p=null,u=function(d){var k=c+g-d.clientX,h=null;if("w"===t||"sw"===t||"nw"===t){var u=a.style.width;h=parseInt(a.style.left)+parseInt(u)-k}if("w"!==t){if("y"===t||"-y"===t||"sw"===t||"se"===t||"nw"===t||"ne"===t)if(u="-y"===t||"ne"===t||"nw"===t?e+f-d.clientY:f+d.clientY-e,50<=u&&u<=p){if("-y"===t||"ne"===t||"nw"===t)a.style.top=parseInt(a.style.top)+parseInt(a.style.height)-u+"px";a.style.height=u+"px"}"sw"!==t&&"nw"!==t&&(k=g+d.clientX-
c)}if("y"!==t&&"-y"!==t){if(500<k||120>k)u=k,k=120>k?120:500,null!==h&&(h=h+u-k);null!==h&&(a.style.left=h+"px");a.style.width=k+"px";d=b.getPanelClass(k);l!==d&&(l&&a.classList.remove(l),a.classList.add(d),l=d,b._setResponsiveTabs(d))}},w=function(){r.document.body.classList.remove("tb_start_animate");r.document.body.classList.remove("tb_panel_resize");r.document.removeEventListener("mousemove",u,{passive:!0});r.document.removeEventListener("mouseup",w,{passive:!0});c=g=t=l=null;b.updateStorage()},
B=k.length-1;-1<B;--B)k[B].addEventListener("mousedown",function(b){1===b.which&&(r.document.body.classList.add("tb_start_animate"),r.document.body.classList.add("tb_panel_resize"),t=this.dataset.axis,c=b.clientX,e=b.clientY,p=h(x).height()-50,f=parseInt(h(a).outerHeight(),10),g=parseInt(h(a).outerWidth(),10),r.document.addEventListener("mousemove",u,{passive:!0}),r.document.addEventListener("mouseup",w,{passive:!0}))},{passive:!0})},setFloat(){var a=this.Panel.el.find("#tb_module_panel");a[0].classList.add("tb_panel_floating");
...
m.showLoader("error");m.Lightbox.close()}})},{buttons:{no:{label:ThemifyConstructor.label.replace_builder},yes:{label:ThemifyConstructor.label.append_builder}}})})})}},unload(){"visual"===c.mode&&q.head.insertAdjacentHTML("afterbegin",'<base target="_parent">');r.onbeforeunload=function(){return c.editing||!c.hasChanged&&!c.undoManager.hasUndo()?null:"Are you sure"}},panelClose(a){a.preventDefault();r.location.reload(!0)},loadLayout(a){a.preventDefault();a.stopPropagation();var b=this,d=r.document.body,
...
nonce:themifyBuilder.tb_load_nonce,layout_slug:d.data("slug"),layout_group:e,mode:"no"!==a?1:0},beforeSend(){"visual"===c.mode&&m.showLoader("show")},success(a){a.data?(a.gs&&(c.GS.styles=h.extend(!0,{},a.gs,c.GS.styles)),f(a.data),m.showLoader()):(m.showLoader("error"),alert(a.msg),m.Lightbox.close())}})},{buttons:{no:{label:ThemifyConstructor.label.layout_replace},yes:{label:ThemifyConstructor.label.layout_append}}})})}function g(){a();const b=l.find(".layout_preview_list");t.show().find("li").on("click",
function(a){a.preventDefault();a.stopPropagation();this.classList.contains("current")||(a=b,this.classList.contains("all")||(b.hide(),a=b.filter("[data-category"+(""!==themifyBuilder.paths.layouts_index?"*":"")+'="'+h(this).text()+'"]')),a.show(),h(this).addClass("current").siblings().removeClass("current"),t.parent().find(".tb_ui_dropdown_label").html(h(this).text()));c.Utils.hideOnClick(t)});t.find(".tb_selected_cat").click();k.find("#tb_layout_search").on("keyup",function(){let a=h.trim(h(this).val());
var c=b;""!==a&&(c=t.find("li.all"),c[0].classList.contains("current")||c.click(),b.hide(),c=b.find(".layout_title:contains("+a+")").closest(".layout_preview_list"));c.show()})[0].focus();v.body.one("themify_builder_lightbox_close.loadLayout",function(){k.off("click.loadLayout")[0].classList.remove("tb_predesigned_lightbox");l.find("#tb_layout_search").off("keyup");l=k=null;d.classList.remove("tb_load_layout_active");d.classList.remove("tb_standalone_lightbox");e.removeClass("tb_current_menu_selected")})}
var k=this.$lightbox,l=k.find("#tb_tabs_pre-designed");if(0===l.length)d.classList.remove("tb_load_layout_active"),d.classList.remove("tb_standalone_lightbox"),e.removeClass("tb_current_menu_selected"),a();else{k[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(r.innerWidth/2,(r.document.documentElement.clientHeight-k.height())/2,!0);var t=l.find(".tb_ui_dropdown_items");b.layoutsList?g():h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_predesigned_layouts",
nonce:themifyBuilder.tb_load_nonce,src:themifyBuilder.paths.layouts_index,id:themifyBuilder.post_ID},success(a){const d=JSON.parse(a.data);if(""===themifyBuilder.paths.layouts_index){var e=Object.keys(d);c.layouts_selected={};for(var f=e.length-1;-1<f;--f)c.layouts_selected[d[e[f]].slug]=d[e[f]].data}{a=a.selected;e={};f=q.createDocumentFragment();const u=q.createDocumentFragment();for(let b=0,g=d.length;b<g;++b){var h=q.createElement("li"),p=q.createElement("div");let g=q.createElement("div"),k=
q.createElement("img"),l=q.createElement("div");var m=q.createElement("div");h.className="layout_preview_list";h.dataset.category=d[b].category;p.className="layout_preview";p.dataset.id=d[b].id;p.dataset.slug=d[b].slug;g.className="thumbnail";k.src=d[b].thumbnail;k.alt=d[b].title;k.title=d[b].title;l.className="layout_action";m.className="layout_title";m.textContent=d[b].title;l.appendChild(m);n!==d[b].url&&(m=q.createElement("a"),m.className="layout-preview-link",m.href=d[b].url,m.target="_blank",
m.title=themifyBuilder.i18n.preview,m.appendChild(c.Utils.getIcon("ti-search")),l.appendChild(m));g.appendChild(k);p.appendChild(g);p.appendChild(l);h.appendChild(p);f.appendChild(h);if(d[b].category){h=String(d[b].category).split(",");for(let b=0,c=h.length;b<c;++b)""!==h[b]&&1!==e[h[b]]&&(p=q.createElement("li"),p.textContent=h[b],u.appendChild(p),e[h[b]]=1,h[b]===a&&(p.className="tb_selected_cat"))}}t[0].appendChild(u);l[0].getElementsByClassName("tb_layout_lists")[0].appendChild(f);b.layoutsList=
...
q.getElementById("tb_custom_css_tmp");null===a&&(a=q.createElement("style"),a.type="text/css",a.id="tb_custom_css_tmp",q.head.appendChild(a));a.innerHTML=this.value.trim()});b.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",function(a){a.stopImmediatePropagation();a.preventDefault();y=f.value.trim();m.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);v.body.one("themify_builder_lightbox_close",function(){y||(y="",d.classList.add("tb_tooltip_active"));const a=q.getElementById("tb_custom_css_tmp");
...
init(){h(q).one("tb_panel_tab_tb_module_panel_library_wrap",this.load.bind(this))},load(a,b){const d=this;b=h(b).find(".tb_module_panel_library_wrap");b.addClass("tb_busy");h.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,part:"all",pid:themifyBuilder.post_ID},success(a){d.setData(a);b.removeClass("tb_busy");d.is_init=!0},error(){b.removeClass("tb_busy");m.showLoader("error");d.init();c.toolbar.$el.find(".tb_library_item_list").html("<h3>Failed to load Library Items.</h3>")}})},
...
g=f.length;for(let d=0;d<g&&!(10<=e&&n==a);d++){let g=this.items[f[d]];var k=""!==a?new RegExp(a,"i"):!1;if(!k||!k.test(g.title))continue;var h=g.category.split(",");if("All"!==b&&-1===h.indexOf(b))continue;delete this.items[f[d]];k="";for(let a=0,b=h.length;a<b;++a)k+=this.categories[h[a]].hash;h=q.createElement("div");let l=q.createElement("figure"),t=q.createElement("div"),m=new Image,r=q.createElement("a");h.className="predesigned_row "+k;h.setAttribute("data-slug",g.slug);l.className="tb_predesigned_rows_image";
t.className="tb_predesigned_rows_title";t.textContent=m.alt=m.title=g.title;m.src=g.thumbnail===n||""===g.thumbnail?"https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(g.title)+"&w=181&h=77":g.thumbnail;m.width=500;m.height=300;r.href="#";r.className="tf_plus_icon add_module_btn tb_disable_sorting";r.dataset.type="predesigned";l.appendChild(m);l.appendChild(r);h.appendChild(l);h.appendChild(t);c.appendChild(h);++e}this.categories[b].isLoaded=10>e&&n===a;return c},setData(a){this.items=
a;var b=[];a=q.createDocumentFragment();const d=this;for(let a=0,c=this.items.length;a<c;++a){var e=this.items[a].category.split(",");for(let a=0,c=e.length;a<c;++a){var f=v.hash(e[a]);-1===b.indexOf(e[a])&&(b.push(e[a]),this.categories[e[a]]={hash:"tb"+f})}}b.sort();for(let c=0,d=b.length;c<d;++c)e=q.createElement("li"),e.setAttribute("data-slug",v.hash(b[c])),e.textContent=b[c],a.appendChild(e);b=h(".tb_module_panel_container .tb_ui_dropdown .tb_ui_dropdown_items");e=h(".tb_predesigned_rows_container");
...
pageBreakModule:{init(){"visual"===c.mode?c.Mixins.Builder.initRowVisualDrag(".tb_page_break_module"):c.Mixins.Builder.initRowDraggable(c.toolbar.$el.find(".tb_module_panel_modules_wrap").first(),".tb_page_break_module")},countModules(){const a="visual"===c.mode?q.getElementsByClassName("module-page-break"):q.getElementsByClassName("tb-page-break");for(let b=a.length-1;-1<b;--b)"visual"===c.mode?a[b].getElementsByClassName("page-break-order")[0].textContent=b+1:a[b].getElementsByClassName("page-break-overlay")[0].textContent=
"PAGE BREAK - "+(b+1)},get(){return[{cols:[{grid_class:"col-full first last",modules:[{mod_name:"page-break"}]}],column_alignment:"col_align_middle",styling:{custom_css_row:"tb-page-break"}}]}},common:{btn:null,is_init:null,clicked:null,init(){const a=this;let b=q.createElement("div"),d=c.toolbar.$el;b.className="tb_modules_panel_wrap";b.id="tb_module_panel_dropdown";this.btn=h(b);d=d.add(m.Lightbox.$lightbox);"visual"!==c.mode&&null!==q.querySelector(".edit-post-layout__content")?h(".edit-post-layout__content")[0].appendChild(this.btn[0]):
...
a.tb_device?"tablet_landscape"===b?a.tb_device[1]:a.tb_device[0]:c.Utils.getBPWidth(b)-1:"";if(k===b&&a.originalEvent!==n&&(f?f+"px":f)===c.iframe[0].style.width)return!1;c.ActionBar.disable=!0;var t=[];if("visual"===c.mode){null===c.clearOnModeChange&&c.ActionBar.clear();if(!g&&!c.isPreview){var p=c.Instances.Builder[0].el.children;const a=x.innerHeight,b=function(b){if(null!==b&&b!==n){const c=b.getBoundingClientRect();if(0>c.bottom&&0>c.top||c.top>a)b.style.display="none",t.push(b)}};for(let a=
p.length-1;-1<a;--a)b(p[a]);b(q.getElementById("headerwrap"));b(q.getElementById("footerwrap"))}d=d.add(v.body)}c.activeBreakPoint=b;d.addClass("tb_start_animate");if("visual"===c.mode)if(c.iframe[0].style.willChange="width",p=r.document.getElementsByClassName("tb_toolbar_zoom_menu")[0],p.classList.remove("tb_toolbar_zoom_active"),p.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100,"tablet_landscape"===b&&m.Lightbox.dockMode.get()&&(p=h(".tb_workspace_container",r.document).width(),
p<f&&(f=p)),c.iframe[0].parentNode.classList.remove("tb_zoom_bg"),g)l();else{r.document.body.offsetHeight;let d;c.isPreview&&(p={tablet_landscape:[1024,768],tablet:[768,1024],mobile:[375,667]},p[b]!==n&&(f=n===a.tb_device?p[b][0]:"tablet_landscape"===b?a.tb_device[1]:a.tb_device[0],d=n===a.tb_device?p[b][1]:"tablet_landscape"===b?a.tb_device[0]:a.tb_device[1]));c.iframe.one("transitionend",function(){for(let a=t.length-1;-1<a;--a)t[a].style.display="";setTimeout(l,10)});c.iframe[0].style.width=f?
f+"px":"";c.iframe[0].style.height=d?d+"px":""}else l()}},iframeScroll(a){const b=h(r.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){x.scrollTo(0,h(this).scrollTop())})},responsive_grids(a,b){v.LoadCss(tbLocalScript.css_module_url+"responsive-column.css");const c=q.querySelectorAll(".row_inner,.subrow_inner"),e="desktop"===a,f=e||"desktop"===b;for(let d=c.length-1;-1<d;--d){var g=c[d].getAttribute("data-basecol");if(null!==g){let l=c[d].children;
var k=c[d].dataset["col_"+a];let p=l[0],u=l[l.length-1];if(!e){if("desktop"!==b){c[d].classList.remove("tb_3col");let a=c[d].getAttribute("data-col_"+b);a&&c[d].classList.remove(h.trim(a.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(k&&"-auto"!==k&&k!==a+"-auto"){if(k=c[d].getAttribute("data-col_"+a)){c[d].classList.add("tb_grid_classes");c[d].classList.add("col-count-"+g);k=k.split(" ");for(let a=0,b=k.length;a<b;++a)c[d].classList.add(h.trim(k[a].replace("mobile",
...
"tb_lb_option_child":"tb_lb_option");for(var f=a.length-1;-1<f;--f){var g=this.parseSettings(a[f],c);!1===g||!0!==b&&""===g.v||(d[g.id]=g.v)}}return d},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,id:null,init:!1,html:null,el:null,options:null,isSaved:null,scrollTo(a,b){c.scrollTo=c.Forms.LayoutPart.el},edit(a){function b(a){c.ActionBar.clear();q.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>');f.addClass("tb_active_layout_part").closest(".row_inner").find(".active_module").each(function(){this.classList.contains("tb_active_layout_part")||
...
c.id=!1);c.Instances.Builder[c.builderIndex].$el.triggerHandler("tb_init");m.showLoader("hide");"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(h("body",r.document).height(q.body.scrollHeight),setTimeout(function(){h("body",r.document).height(q.body.scrollHeight)},2E3));d&&d();c.hasChanged=!0;"visual"===c.mode&&setTimeout(function(){c.Utils.checkAllimageSize()},500)}var f=a.builder_data!==n?a.builder_data:a;a.used_gs!==n&&(c.GS.styles=h.extend(!0,{},a.used_gs,c.GS.styles));var g=null!==c.Forms.LayoutPart.id,
k=c.builderIndex,l=null,t="";c.Mixins.Builder.updateModuleSort(null,"destroy");g||(c.Models.Registry.destroy(),c.Instances.Builder={});"visual"===c.mode?(t="#themify_builder_content-"+b,c.id=b,g||(c.liveStylingInstance.reset(),c.editing=!1,v.body.addClass("sidebar-none full_width"),h("#sidebar,.page-title").remove())):t="#tb_row_wrapper";if(g){b=c.Instances.Builder[k].el.querySelectorAll("[data-cid]");c.Forms.LayoutPart.isReload=!0;for(var p=0,u=b.length;p<u;++p){var w=b[p].dataset.cid,B=c.Models.Registry.lookup(w);
B&&(B.destroy(),c.Models.Registry.remove(w))}b=null;c.Instances.Builder[k].$el.empty()}c.Instances.Builder[k]=new c.Views.Builder({el:t,collection:new c.Collections.Rows(f),type:c.mode});c.Instances.Builder[k].render();c.undoManager.reset();if(g){l=[];b=c.Instances.Builder[k].el.querySelectorAll("[data-cid]");p=0;for(u=b.length;p<u;++p)l[b[p].dataset.cid]=1;b=null}"visual"===c.mode?c.bootstrap(l,e,a.used_gs!==n?a.used_gs:null):e()},isValidate(a){var b=a.getElementsByClassName("tb_must_validate"),
d=b.length;if(0===d)return!0;var e=!0;for(--d;-1<d;--d){var f=b[d].getElementsByClassName("tb_lb_option")[0],g=b[d].getAttribute("data-validation"),h=f.value;if(c.Forms.get_validator(g)(h))for(f.classList.remove("tb_field_error"),f=b[d].getElementsByClassName("tb_field_error_msg"),g=f.length-1;-1<g;--g)f[g].parentNode.removeChild(f[g]);else f.classList.contains("tb_field_error")||(e=q.createElement("span"),e.className="tb_field_error_msg",e.textContent=b[d].getAttribute("data-error-msg"),f.classList.add("tb_field_error"),
...
0,d=a.length;b<d;++b){a[b].classList.contains("active_module")||l(a[b]);var e=c.Models.Registry.lookup(a[b].getAttribute("data-cid"));e&&(f=e.get("mod_settings"),e=w.push({mod_name:e.get("mod_name"),element_id:e.get("element_id")})-1,f&&0<Object.keys(f).length&&(delete f.cid,w[e].mod_settings=f),a[b].classList.contains("module_subrow")&&(w[e]=h._getRowSettings(a[b],"subrow")))}};b=0;for(var m=e.length;b<m;++b){var p={},u=c.Models.Registry.lookup(e[b].getAttribute("data-cid"));if(u){p=e[b].getElementsByClassName("tb_holder")[0];
var w=[];p!==n&&l(p);p=d.push({element_id:u.get("element_id"),grid_class:this.filterClass(e[b].className)});--p;w&&0<w.length&&(d[p].modules=w);var q=parseFloat(e[b].style.width);0<q&&!isNaN(q)&&(d[p].grid_width=q);(f=u.get("styling"))&&0<Object.keys(f).length&&(delete f.cid,d[p].styling=f)}}e={element_id:g.get("element_id"),cols:d,column_alignment:g.get("column_alignment"),gutter:g.get("gutter"),column_h:g.get("column_h")};m={gutter:"gutter-default",column_alignment:C?"col_align_middle":"col_align_top"};
...
f=a.getElementsByClassName(b+"_inner")[0],g=e.get("gutter"),h=e.get("column_alignment"),l=e.get("column_h"),m=e.get("desktop_dir"),p="row"===b?e.get("styling"):null;b=[];for(var u={},w=f.children,q=0,r=w.length;q<r;++q)w[q].className=w[q].className.replace(/first|last/ig,""),1!==r&&(0===q?w[q].className+="rtl"===m?" last":" first":q===r-1&&(w[q].className+="rtl"===m?" first":" last"));w=w.length;b.push("col-count-"+w);u["data-basecol"]=w;null!==p&&p.row_anchor!==n&&""!==p.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=
p.row_anchor);"gutter-default"!==g&&b.push(g);l&&b.push("col_auto_height");h||(h="col_align_top");b.push(h);"ltr"!==m&&b.push("direction-rtl");for(a=d.length-1;-1<a;--a)m=e.get(d[a]+"_dir"),"ltr"!==m&&""!==m&&(u["data-"+d[a]+"_dir"]=m),"desktop"!==d[a]&&(w=e.get("col_"+d[a]),"-auto"!==w&&""!==w&&w!==n&&(u["data-col_"+d[a]]=w));for(q=b.length-1;-1<q;--q)b[q]&&f.classList.add(b[q]);for(q in u)f.setAttribute(q,u[q])},clear(a,b,d){b===n&&(b=Array.isArray(a));var e=!0===b?[]:{},f=x.tbpDynamic!==n?tbpDynamic.field_name:
...
g,h(this).css("width",a+"%"))})}else{var k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},q={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):h(".tb_grid_drag")).each(function(){var a,b,d,e,g=0,n,t=
...
start(c,f){d=b.children(".module_column");e=a.closest(".module_column");y=b[0].classList.contains("direction-rtl");"w"===n?(t=y?e.prev(".module_column"):e.next(".module_column"),g=a.outerWidth(),D=e.outerWidth()):(t=y?e.next(".module_column"):e.prev(".module_column"),D=g=e.outerWidth());g=parseInt(g);r=parseInt(t.outerWidth())-2;x=b.outerWidth();z=e.addClass("tb_drag_column_current").children("."+E)[0];A=e.children(".tb_grid_drag_tooltip").last()[0]},stop(a,m){h(".tb_grid_drag_tooltip").remove();
b.removeClass("tb_drag_column_start");a=Math.ceil(100*(e.outerWidth()/x));e.removeClass("tb_drag_column_current").css("width",a+"%");var p=k;a=3.2;b[0].classList.contains("gutter-narrow")?(p=l,a=1.6):b[0].classList.contains("gutter-none")&&(p=q,a=0);var u=a*(d.length-1);d.each(function(a){a!==t.index()&&(h(this).prop("style").width?a=parseFloat(h(this).prop("style").width):(a=h.trim(f.filterClass(h(this).attr("class")).replace("first","").replace("last","")),a=p[a]),u+=a)});t.css("width",100-u+"%");
t=t.add(e);f.setCompactMode(t);a=b.closest(".module_row");m=!0===c.hasChanged;c.hasChanged=!0;c.undoManager.push(a.data("cid"),G,a,"row");c.hasChanged=m;v.body.triggerHandler("tb_grid_changed",[a]);z=A=g=r=x=D=t=E=e=n=y=b=d=null},drag(a,b){if(t&&0<t.length&&(a=parseInt(b.position.left),a=g+("e"===n?-a:a),b=parseFloat(100*a/x),5<=b&&100>b)){var c=r;c+="w"===n?-(a-D):D-a;var d=parseFloat(100*c/x);5<d&&100>d&&(t.css("width",c+"px"),e.css("width",a+"px"),z.innerHTML=b.toFixed(2)+"%",A.innerHTML=d.toFixed(2)+
...
b?this.id:"hide_anchor",t="custom_css_id"===l,p=!0!==t||!1!==k&&!0!==f?n:m.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];var u=!0===k&&!1===f?h(".tb_element_cid_"+c.ActionBar.cid):"visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:h(".tb_element_cid_"+c.activeModel.cid);var w=!1===f&&!0===k?m.clone(u[0]):null;var r=this.value;"keyup"===d&&"custom_css"!==b?((r=r.trim())&&(r=r.replace(/[^a-zA-Z0-9\-_]+/gi,"")),this.value=r):"layout"===b?r=a.detail.val:"hide_anchor"===b&&
(r=this.checked?"1":"0");if(e[b].call(e,this,l,u,r)){t&&(h(this).next(".tb_field_error_msg").remove(),p!==n&&p.classList.remove("tb_disable_save"));if(!0===k){var v=function(){var a=r;"keyup"===d&&(this.removeEventListener("change",v,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var b=u.data("cid"),e=c.Models.Registry.lookup(b),f=h.extend(!0,{},e.get("styling"));f||(f={});var g=h.extend(!0,{},f);f[l]=a;e.set({styling:f},{silent:!0});null!==w&&c.undoManager.push(b,
w,u,"save",{bsettings:g,asettings:h.extend(!0,{},f)})};"keyup"===d?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",v,{passive:!0,once:!0})):v()}c.hasChanged=!0}else t&&(a=q.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),p!==n&&p.classList.add("tb_disable_save"));!0===f&&(f=k?m.Lightbox.$lightbox.find("#"+l):h("#"+c.ActionBar.el.id).find("#"+l),
"keyup"===d?f.val(r).attr("data-prev",r):"layout"===b?(f.find(".selected").removeClass("selected"),""!==r?f.find("#"+r).addClass("selected"):f.children().first().addClass("selected")):"hide_anchor"===b&&(f.find("INPUT")[0].checked=this.checked));"keyup"===d&&this.setAttribute("data-prev",r)},{passive:!0})},visibilityLabel(a,b){if(b===n){var d=c.Models.Registry.lookup(a.getAttribute("data-cid"));d&&(b="module"!==d.get("elType")?d.get("styling"):d.get("mod_settings"))}if(b){d="";a=a.getElementsByClassName("tb_visibility_hint")[0];
const c={visibility_desktop:themifyBuilder.i18n.de,visibility_mobile:themifyBuilder.i18n.mo,visibility_tablet:themifyBuilder.i18n.ta,visibility_tablet_landscape:themifyBuilder.i18n.ta_l,sticky_visibility:themifyBuilder.i18n.s_v};if(a!==n){if("hide_all"===b.visibility_all)d=themifyBuilder.i18n.h_a;else{let a;for(let e in c)a=""===d?"":", ",d+="hide"===b[e]?a+c[e]:""}""!==d?(b=a.getElementsByTagName("span")[0],b===n&&(b=q.createElement("span"),a.appendChild(b)),b.textContent=d,a.classList.add("tb_has_visiblity")):
...
this.el.addEventListener("mousedown",this.mouseDown.bind(this));this.topH=c.toolbar.$el.height();"visual"===c.mode?q.body.appendChild(this.el):c.Instances.Builder[c.builderIndex].el.parentNode.appendChild(this.el);q.addEventListener("click",this.click.bind(this));q.addEventListener("dblclick",this.click.bind(this));c.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===c.mode&&r.document.addEventListener("click",this.click.bind(this));var a="visual"===c.mode?null:q.getElementById("tb_canvas_block");
null===a?(q.addEventListener("keydown",this.actions.bind(this)),r.document.addEventListener("keydown",this.actions.bind(this))):a.addEventListener("keydown",this.actions.bind(this));this.changeMode();this.initRightClick(!0)}},changeMode(){this.hoverCid=null;var a=this,b=function(b){a.actions(b)};!0===this.isHoverMode?(q.body.classList.remove("tb_click_mode"),q.body.classList.add("tb_hover_mode"),this.el.removeEventListener("click",b)):(q.body.classList.remove("tb_hover_mode"),q.body.classList.add("tb_click_mode"),
...
this.rightClick))},enter(a){var b=c.ActionBar;c.Mixins.Builder.columnHover(a.target);if(!0===b.isHoverMode&&null===b.disablePosition&&null===b.disable){a.preventDefault();a.stopPropagation();var d=a.target,e=null,f=d.classList;if(null!==b.prevExpand&&b.prevExpand!==n)if(b.prevExpand.contains(d)){if(f.contains("tb_inner_action_more")||f.contains("tb_action_more")){var g=d.getElementsByTagName("ul")[0];g!==n&&c.Utils.addViewPortClass(g)}g=b.prevExpand.getElementsByClassName("tb_row_settings")[0];if(g!==
n){var k=q.getElementById(g.getAttribute("data-href"));if(k.contains(d))return;k.classList.remove("selected");g.classList.remove("selected")}if("module"===b.type||"column"===b.type){"column"===b.type&&(b.hoverCid=d.parentNode.getAttribute("data-cid"));return}}else{g="module"!==b.type;if(!1===g)"visual"!==c.mode?(g=d.closest(".active_module"),g=null!==g?g.getAttribute("data-cid")!==b.hoverCid:!0):(k=d.closest(".tb_dragger_top"),null!==k&&k.classList.contains("tb_dragger_padding")&&c.EdgeDrag.setModulePosition(k));
else if(f.contains("tb_clicked"))return;!0===g&&b.clear()}if(null===d.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))e=!f.contains("tb_clicked");else{if("LI"===d.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){b.actions(a);return}if(!f.contains("tb_grid_drag")){d=h(d).closest("[data-cid]")[0];if(d===n)return;f=d.getAttribute("data-cid");if(b.hoverCid===f)return;b.hoverCid=f;g=c.Models.Registry.lookup(f);f=g.get("elType");if("module"===f)e=!0;else if("visual"===
c.mode){b.clear();c.EdgeDrag.addEdges(f,g,d);return}}}!0===e&&b.click(a)}}},rightClickGS(a,b,d){this.disable=!0;null!==c.activeModel&&h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click();var e=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),f=c.GS.key;b=b.split(" ");for(var g=b.length,k=e.length-1;-1<k;--k){var l=c.Models.Registry.lookup(e[k].getAttribute("data-cid")),q=m.clone(e[k]),p="module"===l.get("elType")?"mod_settings":"styling",n=h.extend(!0,
{},l.get(p)),w=h.extend(!0,{},n);c.activeModel=l;if(n[f])if(!0===d)a&&-1!==n[f].indexOf(a)&&(n[f]=n[f].split(" "),n[f].splice(n[f].indexOf(a),1),n[f]=n[f].join(" "));else for(var r=0;r<g;++r)-1===n[f].indexOf(b[r])&&(n[f]+=" "+b[r]);else{if(0===g)continue;n[f]=b.join(" ")}r={};r[p]=n;l.set(r,{silent:!0});c.GS.generateValues(a,n[f].split(" "),d);c.undoManager.push(l.cid,q,h(e[k]),"save",{bsettings:w,asettings:n})}this.disable=null;c.activeModel=null},rightClick(a,b){a.stopImmediatePropagation();var d=
c.ActionBar;if(null===d.contextMenuAnimate){d.contextMenuAnimate=!0;if(null===d.contextMenu){var e=function(a){a.stopPropagation();"click"===a.type&&null===a.target.closest(".tb_visibility_wrap")&&a.preventDefault();if("LI"===a.target.nodeName||a.target.classList.contains("toggle_switch")){var b="LI"===a.target.nodeName?a.target.getAttribute("data-action"):"visibility";if(b){d.disable=!0;d.hoverCid=null;if("undo"===b||"redo"===b)if(a="undo"===b?c.undoManager.btnUndo:c.undoManager.btnRedo,"undo"===
b&&c.undoManager.hasUndo()||"redo"===b&&c.undoManager.hasRedo())h(a).triggerHandler("click"),d.disable=null;else{d.disable=null;return}else{var e=this.classList.contains("tb_multiply_selected"),f=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),g=n;"gs_in"!==b&&"move"!==b&&(!0!==e||"delete"!==b&&"paste"!==b||(g=!0),h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click());if("reset"===b)var k=c.activeModel,l=h.extend(!0,{},ThemifyConstructor.values),
p=ThemifyConstructor.component,q=ThemifyConstructor.beforeData,t=!0===c.hasChanged,u="visual"===c.mode?c.liveStylingInstance.prefix:null,r="visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:null;else{if("move"===b){d.disable=null;return}if("gs_in"===b){if(!1===e){b=c.Models.Registry.lookup(f[0].dataset.cid);var w=h.extend(!0,{},ThemifyConstructor.values);ThemifyConstructor.values="module"===b.get("elType")?b.get("mod_settings"):b.get("styling")}if(b=c.GS.globalStylesHTML())a=d.contextMenu.querySelector("#tb_inline_gs"),
a.innerHTML="",a.appendChild(b),a.getElementsByClassName("tb_gs_icon")[0].click(),a.querySelector('[data-action="insert"]').click(),a.classList.add("tb_inline_gs_show"),c.Utils.addViewPortClass(d.contextMenu);!1===e&&(ThemifyConstructor.values=w);d.disable=null;return}}for(e=f.length-1;-1<e;--e){var v=f[e].getAttribute("data-cid"),x=c.Models.Registry.lookup(v),y=x.get("elType");w="module"===y?x.get("mod_settings"):x.get("styling");if("reset"===b||"gs_r"===b){if("gs_r"!==b||w[c.GS.key]!==n){if(null!==
c.activeModel&&c.activeModel.cid===v){var z=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];if(z!==n){z.click();continue}}z=m.clone(f[e]);var A;c.activeModel=x;"reset"===b&&(ThemifyConstructor.component=y,ThemifyConstructor.values=w);var C="module"===y?"mod_setting":"styling";"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt?c.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===y?c.activeModel.get("mod_name"):y,c.activeModel.get("element_id")):c.liveStylingInstance.init(!0),
c.liveStylingInstance.$liveStyledElmt=h(f[e]));y=h.extend(!0,{},w);"reset"===b?(w=ThemifyConstructor.resetStyling(a,null!==k&&k.cid!==v),"visual"===c.mode&&(A=h.extend(!0,{},w)),w=h.extend(!0,{},ThemifyConstructor.values)):(delete w[c.GS.key],c.GS.generateValues(null,[],!0));var H={};H[C]=w;x.set(H,{silent:!0});c.hasChanged=!0;c.undoManager.push(v,z,h(f[e]),"save",{bsettings:y,asettings:w,styles:A});A=null}}else("delete"!==b&&"visibility"!==b||"column"!==y)&&x.trigger(b,a,a.target,g)}"reset"===b?
(c.hasChanged=t,c.activeModel=k,ThemifyConstructor.values=l,ThemifyConstructor.component=p,ThemifyConstructor.beforeData=q,"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt=r,c.liveStylingInstance.prefix=u)):"edit"!==b&&(c.activeModel=null);d.disable=null}"visibility"!==b&&d.hideContextMenu()}}},f=function(a){a.stopPropagation();a.target.classList.contains("tb_inner_action_more")&&(a=a.target.getElementsByTagName("ul")[0],a!==n&&c.Utils.addViewPortClass(a))};d.contextMenu=q.getElementById("tb_right_click");
null===d.contextMenu&&(d.contextMenu=q.getElementById("tmpl-builder_right_click").content,q.body.appendChild(d.contextMenu),d.contextMenu=q.getElementById("tb_right_click"),d.contextMenu.addEventListener("click",e),d.contextMenu.addEventListener("mouseover",f,{passive:!0}),d.contextMenu.getElementsByClassName("tb_r_name")[0].addEventListener("mousedown",function(a){1!==a.which||d.contextMenu.classList.contains("tb_multiply_selected")||d.contextMenu.classList.contains("tb_component_column")||(a.preventDefault(),
a.stopPropagation(),a=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked")[0],a!==n&&(d.hideContextMenu(),d.cid=a.dataset.cid,d.moveComponent()))}))}var g=!0;!0!==d.isHoverMode&&null!==d.cid?b=c.Instances.Builder[c.builderIndex].el.querySelector('[data-cid="'+d.cid+'"]'):b?g=!1:b=h(a.target).closest("[data-cid]")[0];if(b===n)d.contextMenuAnimate=null;else{a.preventDefault();d.hideContextMenu(a.target.classList.contains("tb_bread"));d.disablePosition=!0;q.body.classList.add("tb_right_click_open");
d.contextMenu.className="tb_show_context";var k=a.pageX,l=a.pageY,t=c.Models.Registry.lookup(b.dataset.cid),p=t.get("elType"),u=function(e){if("transform"===e.propertyName){var f=c.Instances.Builder[c.builderIndex].el;e=this.getElementsByClassName("tb_r_name")[0];var h=this.getElementsByClassName("tb_action_breadcrumb")[0],m=function(a){a.preventDefault();a.stopPropagation();var b=a.target.getAttribute("data-id");b&&(this.removeEventListener("click",m),d.hideContextMenu(!0),b=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+
b)[0],b!==n&&d.rightClick(a,b))};this.removeEventListener("transitionend",u,{passive:!0});this.className="tb_component_"+p;"module"===p&&(this.className+=" tb_module_"+t.get("mod_name"));h.innerHTML="";if(!0===a.ctrlKey||!0===a.metaKey)b.classList.add("tb_element_clicked");else if(!b.classList.contains("tb_element_clicked")){var q=f.getElementsByClassName("tb_element_clicked");for(var r=q.length-1;-1<r;--r)q[r].classList.remove("tb_element_clicked");b.classList.add("tb_element_clicked")}q=f.getElementsByClassName("tb_element_clicked").length;
1<q?(this.className+=" tb_multiply_selected",e.textContent=themifyBuilder.i18n.multiSelected):(f=null===d.breadCrumbsPath.rightClick?t.cid:d.breadCrumbsPath.rightClick[d.breadCrumbsPath.rightClick.length-1],d.breadCrumbsPath.rightClick=d.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+f)[0],"rightClick"),f=null,h.appendChild(d.getBreadCrumbs(b,"rightClick")),e.textContent="module"===p?themifyBuilder.modules[t.get("mod_name")].name:p);h.addEventListener("click",
m);var w=function(a){"transform"===a.propertyName?(this.removeEventListener("transitionend",w,{passive:!0}),c.Utils.addViewPortClass(this),d.contextMenuAnimate=null):(this.style.top=l+"px",!0===g&&(this.style.left=k+"px"))};this.addEventListener("transitionend",w,{passive:!0});c.undoManager.hasUndo()||(this.className+=" tb_undo_disabled");"column"===p&&(this.className+=" tb_visibility_disabled");c.undoManager.hasRedo()||(this.className+=" tb_redo_disabled");this.className+=" tb_show_context"}};d.contextMenu.addEventListener("transitionend",
u,{passive:!0});setTimeout(function(){d.contextMenu.className=""},18)}}},hideContextMenu(a){if(null!==this.contextMenu){this.contextMenu.style.top="";var b=this.contextMenu.querySelector("#tb_inline_gs");b.classList.contains("tb_inline_gs_show")&&b.classList.remove("tb_inline_gs_show");q.body.classList.remove("tb_right_click_open");this.disablePosition=this.hoverCid=null;!0!==a&&(c.ActionBar.breadCrumbsPath.rightClick=null)}},mouseDown(a){1!==a.which||"row"!==this.type&&"subrow"!==this.type||!a.target.classList.contains("tb_move")||
(a.preventDefault(),a.stopPropagation(),this.moveComponent())},moveComponent(){var a=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.cid)[0];if(a!==n){var b=a.classList.contains("module_row")?a.getElementsByClassName("tb_row_action")[0]:a;a=h(a).offset();this.clear();if("function"===typeof Event)var d=new Event("mousedown",{bubbles:!0,cancelable:!1});else d=q.createEvent("Event"),d.initEvent("mousedown",!0,!1);d.pageX=a.left;d.pageY=a.top;d.which=1;b.dispatchEvent(d)}},
click(a){if(c.isPreview||!0===this.disable)return!0;var b=a.target,d=b.tagName,e=null,f=c.Instances.Builder[c.builderIndex].lastRow,g="visual"===c.mode&&b.ownerDocument===r.document?n:h(b).closest("[data-cid]")[0],k=a.type;if("click"===k){this.hideContextMenu();e=!0===a.ctrlKey||!0===a.metaKey;if(r.document.body.classList.contains("tb_standalone_lightbox")&&!r.document.body.classList.contains("modal-open")){c.toolbar.el.contains(b)||m.Lightbox.$lightbox[0].contains(b)||m.Lightbox.$lightbox[0].classList.contains("tb_predesigned_lightbox")||
m.Lightbox.close();var l=r.document.getElementsByClassName("tb_current_menu_selected")[0];l!==n&&l.classList.remove("tb_current_menu_selected");l=null}f&&!f.contains(b)&&f.classList.remove("expanded");if(!m.Lightbox.$lightbox[0].contains(b)&&(!1===e&&this.clearClicked(),g!==n)){if(!0===e&&g.classList.contains("tb_element_clicked")){g.classList.remove("tb_element_clicked");return}g.classList.add("tb_element_clicked")}}else if("dblclick"===k&&null!==c.Forms.LayoutPart.id&&b.classList.contains("tb_overlay")){c.Forms.LayoutPart.save(a,
!0);return}l=("click"===k||"dblclick"===k)&&"visual"===c.mode&&m.Lightbox.dockMode.get();if(g===n||!("dblclick"===k||!0===l&&b.classList.contains("tb_dragger"))&&b.classList.contains("tb_disable_sorting")||g.classList.contains("tb_active_layout_part"))"LI"===d&&b.classList.contains("tb_bread")?(f=c.Models.Registry.lookup(b.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(a=m.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),
m.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",function(){"row"===ThemifyConstructor.component?m.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+this+'"]').click():null===c.activeModel&&m.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(a)),a=null),a=null===this.breadCrumbsPath.lightbox?c.activeModel.cid:this.breadCrumbsPath.lightbox[this.breadCrumbsPath.lightbox.length-
1],this.breadCrumbsPath.lightbox=this.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+a)[0]),a=null,f.trigger("edit","breadcrumb")):this.el.contains(b)||"click"===a.type&&b.classList.contains("tb_dragger")||this.clear();else{"visual"!==c.mode||"A"!==d&&null===b.closest("a")||a.preventDefault();var t=g.getAttribute("data-cid");f=c.Models.Registry.lookup(t);var p=f.get("elType"),u="row"===p&&g.classList.contains("tb-page-break");if(f){if("dblclick"===k){if((!0===
l||"INPUT"===d||!0===u||b.classList.contains("tb_dragger_lightbox")||null!==b.closest(".tb_clicked"))&&"tb_row_options"!==b.id)return;a.preventDefault();a.stopPropagation();!1===l&&!0!==this.isHoverMode?(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===p?f.get("mod_name"):p,f,g)):g.classList.remove("tb_element_clicked");if(!b.classList.contains("tb_row_settings")){this.hoverCid=null;f.trigger("edit",a,b);return}}else if("click"===
k&&!1===l&&(b.classList.contains("tb_dragger")||null!==b.closest(".tb_dragger_options")))return;var w=!0===this.isHoverMode,B=!0!==w&&null!==this.cid;d="module"!==p?b.classList.contains("tb_action_wrap"):!0===w;this.cid=t;this.type=p;if(!0===u&&"row"===p)this.clear(),b.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),f.trigger("delete",a,b));else if((!1===d||"module"===p&&!0===w)&&null!==b.closest(".tb_action_wrap"))"click"===k&&this.actions(a);else if(!0===w&&"click"===
k&&!0===this.needClear)!0===l&&!1===e&&f.trigger("edit",a,b);else if(this.clear(),!0===B&&"click"===k&&!1===e&&!1===l&&!0===this.needClear){v.body[0].classList.add("tb_action_active");var F=this,x=function(){q.removeEventListener("mousemove",x,{passive:!0,once:!0});null===F.cid&&(v.body[0].classList.remove("tb_action_active"),F.clearClicked())};q.removeEventListener("mousemove",x,{passive:!0,once:!0});q.addEventListener("mousemove",x,{passive:!0,once:!0})}else{this.cid=t;this.type=p;k=q.getElementById("tmpl-builder_"+
p+"_action").content.cloneNode(!0);if(!0===d){this.prevExpand="module"===p?g.getElementsByClassName("tb_module_action")[0]:b;if(this.prevExpand===n){this.clear();return}this.prevExpand.appendChild(k);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===w&&"module"===p&&(k=!0,e=g.getBoundingClientRect(),70>e.height||200>e.width?(this.prevExpand.classList.add("tb_small_action_bar"),this.prevExpand.classList.remove("tb_small_action_bar_top"),
this.prevExpand.classList.remove("tb_small_action_bar_bottom"),this.prevExpand.style.top=0,40>this.prevExpand.getBoundingClientRect().top?(this.prevExpand.style.top="100%",this.prevExpand.classList.add("tb_small_action_bar_top")):this.prevExpand.classList.add("tb_small_action_bar_bottom"),70>e.height?this.prevExpand.classList.add("tb_small_action_bar_height"):this.prevExpand.classList.remove("tb_small_action_bar_height"),200>e.width?this.prevExpand.classList.add("tb_small_action_bar_width"):this.prevExpand.classList.remove("tb_small_action_bar_width"),
k=!1):this.prevExpand.classList.remove("tb_small_action_bar"),"visual"===c.mode&&(!0===k&&75>e.height&&(e=this.prevExpand.nextElementSibling,null!==e&&e.classList.contains("tb_module_btn_plus")&&null!==e.offsetParent||(e=g.parentNode.nextElementSibling),null!==e&&(e=this.prevExpand.getBoundingClientRect().bottom-e.getBoundingClientRect().top,0<=e&&(this.prevExpand.style.top=this.prevExpand.offsetTop-e-2+"px"))),c.EdgeDrag.addEdges(f.get("mod_name"),f,g)))}else("row"!==p||"row"===p&&null!==this.breadCrumbsPath.lightbox)&&
this.setBreadCrumbs(g),this.el.className="tb_show_toolbar tb_"+p+"_action",e=q.createElement("div"),e.className="tb_action_label_wrap",e.appendChild(k),"visual"===c.mode&&("module"===p?(k=f.get("mod_name"),this.el.className+=" tb_"+k+"_action",k=themifyBuilder.modules[k].name):(k=p,"row"===p&&(t=f.get("styling").row_anchor,t!==n&&(t=t.trim(),""!==t&&(k+=" #"+t)))),t=q.createElement("div"),t.className="tb_data_mod_name",t.textContent=k.charAt(0).toUpperCase()+k.slice(1),e.appendChild(t)),this.el.appendChild(e);
!0!==w&&(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===p?f.get("mod_name"):p,f,g));if(!0===l&&(f.trigger("edit",a,b),!0===w||null!==this.disablePosition&&!1!==d&&!0===w))return;null===this.disablePosition&&(!1===d&&!0!==w?(b=a.pageX,g=a.pageY,"visual"!==c.mode&&(e=c.Instances.Builder[0].el.getBoundingClientRect(),b=a.clientX-e.left,g=a.clientY-e.top+30),this.setPosition(this.el,{left:b,top:g})):c.Utils.addViewPortClass(this.prevExpand))}}else!0!==
w&&this.clear()}},setBreadCrumbs(a){for(;null!==this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.firstChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbPath(a,b){b="rightClick"!==b?"lightbox":b;b=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<b.length)return b;if(n!==a){var c=a.getAttribute("data-cid");for(c&&b.push(c);!a.classList.contains("module_row");)a=
a.parentNode,(c=a.getAttribute("data-cid"))&&b.push(c)}return b},getBreadCrumbs(a,b){var d=this.getBreadCrumbPath(a,b),e=q.createDocumentFragment();if(n!==a)for(a="rightClick"===b?a.dataset.cid:c.activeModel?c.activeModel.cid:c.ActionBar.cid,b=d.length-1;-1<b;--b){var f=q.createElement("li"),g=c.Models.Registry.lookup(d[b]),h=g.get("elType");f.textContent="column"===h?g.get("component_name"):"module"===h?g.get("mod_name"):h;f.className="tb_bread tb_bread_"+h;a===d[b]&&(f.className+=" tb_active_bc");
f.setAttribute("data-id",d[b]);e.appendChild(f)}return e},actions(a){var b=a.target,d=b.tagName;if("keydown"===a.type){if("INPUT"!==d&&"TEXTAREA"!==d&&!themifyBuilder.disableShortcuts&&!m.Lightbox.$lightbox[0].contains(b)){d=a.keyCode;var e=q.getElementsByClassName("tb_element_clicked"),f=e.length;if(0<f){a.preventDefault();a.stopPropagation();var g=null,k=null,l=n,t=!0===a.ctrlKey||!0===a.metaKey;46===d||8===d?g="delete":!0===t&&(67===d?(g="copy",f=1):68===d?g="duplicate":86===d&&(g="paste",!0===
a.shiftKey&&(k="style")));1<f&&("delete"===g||"paste"===g)&&(l=!0,null!==c.activeModel&&m.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(b=f-1;-1<b;--b){var p=e[b];if(null===g){if(!0===t&&1===f&&(38===d||40===d)){var u=38===a.which?"up":"down",r="up"===u?p.previousElementSibling:p.nextElementSibling;if(null!==r){if(p.classList.contains("module_row")){if(!r.classList.contains("module_row"))continue;var B=c.Instances.Builder[c.builderIndex].$el}else if(p.classList.contains("active_module")){if(!r.classList.contains("active_module"))continue;
B=h(p.parentNode.closest(".tb_holder"))}else continue;r&&(r=h(p),B.sortable("option","beforeStart")(null,null,{item:r}),B.sortable("option","start")(null,{item:r}),"up"===u?r.prev().before(r):r.next().after(r),B.sortable("option","update")({type:"sortupdate"},{item:r}),B.sortable("option","stop")(null,{item:r,helper:null}),!0!==this.isHoverMode&&p.classList.add("tb_element_clicked"))}}}else"delete"===g&&p.classList.contains("module_column")||(p=c.Models.Registry.lookup(h(p).closest("[data-cid]")[0].getAttribute("data-cid")),
p.trigger(g,a,k,l))}"delete"!==g&&!0===this.isHoverMode||this.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==b.closest(".switch-wrapper"))b.classList.contains("toggle_switch")&&c.Models.Registry.lookup(h(b).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",a,b);else if(a.preventDefault(),null!==this.cid&&("LI"===d||"SPAN"===d||"A"===d)&&(f=(e=b.classList.contains("tb_bread"))?b.getAttribute("data-id"):this.cid,u=null,p=c.Models.Registry.lookup(f),g=b.classList,
p))if(v.body[0].classList.remove("tb_component_menu_active"),!0===e)this.needClear=null,this.disablePosition=!0,q.getElementsByClassName("tb_element_cid_"+f)[0].click(),this.disablePosition=null,"visual"===c.mode&&(b=this.el.getBoundingClientRect(),b.right>=q.body.clientWidth&&this.setPosition(this.el,{left:b.left,top:this.el.offsetTop+55})),this.needClear=!0;else if(u=b.getAttribute("data-href"))for(a=b.parentNode.getElementsByTagName("li"),b=a.length-1;-1<b;--b)d=(p=a[b].getAttribute("data-href"))?
q.getElementById(p):null,e=a[b].classList.contains("selected"),a[b].classList.remove("selected"),null!==d&&d.classList.remove("selected"),p!==u||e||("tb_row_options"===p||"tb_rgrids"===p?this.gridMenu(d):"tb_roptions"===p&&0===d.children.length&&this.setRowOptions(d),d.classList.add("selected"),a[b].classList.add("selected"),c.Utils.addViewPortClass(d),v.body[0].classList.add("tb_component_menu_active"));else{if(g.contains("tb_edit")||g.contains("tb_styling")||g.contains("tb_visibility_component")||
g.contains("tb_swap"))u="edit";else if(g.contains("tb_duplicate"))u="duplicate";else if(g.contains("tb_save_component"))u="save";else if(g.contains("tb_delete"))u="delete";else if(g.contains("tb_import")||g.contains("tb_export"))u="importExport";else if(g.contains("tb_copy_component"))u="copy";else if(g.contains("tb_paste_component")||g.contains("tb_paste_style"))u="paste";else{if("LI"===d||"SPAN"===d||g.contains("tb_action_more")||g.contains("tb_inner_action_more")){a=b.closest("li");if(null===a)return;
e=a.parentNode;u=e.classList;p=u.contains("tb_grid_list")||u.contains("tb_column_alignment")||u.contains("tb_column_gutter")||u.contains("tb_column_direction")||u.contains("tb_column_height")||u.contains("grid_tabs");d=b.classList.contains("selected");e=e.children;if(p&&d)return;for(b=e.length-1;-1<b;--b)if(e[b].classList.remove("selected"),!1===p)for(f=e[b].getElementsByClassName("selected"),g=f.length-1;-1<g;--g)f[g].classList.remove("selected");d||(a.classList.add("selected"),v.body[0].classList.add("tb_component_menu_active"));
if(p)u.contains("tb_column_alignment")?this._columnAlignmentClicked(a):u.contains("tb_column_gutter")?this._gutterChange(a):u.contains("tb_column_direction")?this._columnDirectionClicked(a):u.contains("tb_column_height")?this._columnHeight(a):u.contains("grid_tabs")?this._switchGridTabs(a):u.contains("tb_grid_list")&&this._gridClicked(a);else{e=null!==this.prevExpand?this.prevExpand.children:this.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(b=e.length-1;-1<b;--b)e[b].classList.remove("selected");
d||null!==this.prevExpand&&"column"!==this.type||(e=a.getElementsByTagName("ul")[0],e!==n&&c.Utils.addViewPortClass(e))}}return}if(!0!==this.isHoverMode)this.clear();else{var x=b.closest(".tb_action_more");null!==x&&(x=x.getElementsByTagName("ul")[0],x.style.display="none",setTimeout(function(){null!==x&&(x.style.display="")},100))}p.trigger(u,a,b)}},_switchGridTabs(a){c.ActionBar.disable=c.clearOnModeChange=!0;c.ActionBar.hoverCid=null;c.scrollTo=h(q.getElementsByClassName("tb_element_cid_"+this.cid)[0]);
ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"));"visual"!==c.mode&&this.gridMenu(a.closest(".tb_toolbar_tabs"))},_gridClicked(a){var b=h(a),d=b.data("grid"),e=this.type,f=h(".tb_element_cid_"+this.cid).first(),g=!1,k=c.activeBreakPoint,l="desktop"===k;a=m.clone(f.closest(".module_row"));g="subrow"===e;var t=f.find("."+e+"_inner").first();if(l){e=t;var p=b.data("col");e=e.add(h("#tb_rgrids"));p===n&&(p=1,b.data("col",p));for(k=6;0<k;--k)e.removeClass("col-count-"+k);e.addClass("col-count-"+
p);t.attr("data-basecol",p);l&&b.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=h(this).find(".selected"),b=h(this).data("type"),c=a.data("col");c!==n&&(c>p||4===p&&3===c||4<=p&&4<=c&&p!=c)&&(a.removeClass("selected"),t.removeClass("tb_grid_classes col-count-"+t.attr("data-basecol")+" "+t.attr("data-col_"+b)).attr("data-col_"+b,""),h(this).closest(".tb_grid_list").find("."+b+"-auto").addClass("selected"))})}else return"-auto"!==d[0]?(a="column"+d.join("-"),
p=b.data("col"),3===p&&t.attr("data-basecol")>p&&(a+=" tb_3col"),t.removeClass(t.attr("data-col_tablet")+" "+t.attr("data-col_tablet_landscape")+" "+t.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+t.attr("data-basecol")).attr("data-col_"+k,a)):t.removeClass("tb_grid_classes tb_3col col-count-"+t.attr("data-basecol")+" "+t.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===c.mode&&(h("body",r.document).height(q.body.scrollHeight),c.Utils.calculateHeight()),c.Utils.setCompactMode(t.children(".module_column")),
!1;b=t.children(".module_column");l=d.length;e="module_column"+(g?" sub_column":"")+" col";for(k=0;k<l;++k)f=b.eq(k),0<f.length?f.removeClass(c.Utils.gridClass.join(" ")).addClass(e+d[k]):c.Utils._addNewColumn({newclass:e+d[k],component:g?"sub-column":"column"},t[0]);l<t.children().length&&t.children(".module_column").eq(l-1).nextAll().each(function(){h(this).find(".tb_holder").first().children().appendTo(h(this).prev().find(".tb_holder").first());h(this).remove()});d=t.children();d.removeClass("first last");
t.hasClass("direction-rtl")?(d.last().addClass("first"),d.first().addClass("last")):(d.first().addClass("first"),d.last().addClass("last"));c.Utils.columnDrag(t,!0);f=t.closest(".module_row");c.hasChanged=!0;c.Mixins.Builder.updateModuleSort(f);c.undoManager.push(f.data("cid"),a,f,"row");v.body.triggerHandler("tb_grid_changed",[f])},_columnHeight(a){a=h(a).data("value");if(a!==n){var b=h(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),e=m.clone(b);b=b.find("."+this.type+
"_inner").first();""===a?b.removeClass("col_auto_height"):b.addClass("col_auto_height");d.set({column_h:a},{silent:!0});c.undoManager.push(this.cid,e,h(".tb_element_cid_"+this.cid).first(),"row")}},_columnAlignmentClicked(a){a=h(a);if(a=a.data("alignment")){var b=h(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),e=m.clone(b);b.find("."+this.type+"_inner").first().removeClass(d.get("column_alignment")).addClass(a);d.set({column_alignment:a},{silent:!0});c.undoManager.push(this.cid,
e,h(".tb_element_cid_"+this.cid).first(),"row")}},_columnDirectionClicked(a){a=h(a);if(a=a.data("dir")){var b=h(".tb_element_cid_"+this.cid).first().find("."+this.type+"_inner").first(),d=b.children(".module_column"),e=d.first();d=d.last();var f=c.Models.Registry.lookup(this.cid),g={};g[c.activeBreakPoint+"_dir"]=a;f.set(g,{silent:!0});"rtl"===a?(e.removeClass("first").addClass("last"),d.removeClass("last").addClass("first"),b.addClass("direction-rtl")):(e.removeClass("last").addClass("first"),d.removeClass("first").addClass("last"),
b.removeClass("direction-rtl"));b.attr("data-"+c.activeBreakPoint+"_dir",a)}},_gutterChange(a){if(a=h(a).data("value")){var b=h(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),e=d.get("gutter"),f=m.clone(b);b=b.find("."+this.type+"_inner").first();c.Utils.columnDrag(b,!1,e,a);b.removeClass(e).addClass(a);d.set({gutter:a},{silent:!0});c.undoManager.push(this.cid,f,h(".tb_element_cid_"+this.cid).first(),"row")}},gridMenu(a){var b=c.activeBreakPoint,d="desktop"===b,e=c.Models.Registry.lookup(this.cid),
f=e.get(b+"_dir"),g=e.get("column_alignment"),k=e.get("column_h");e=e.get("gutter");var l=q.getElementsByClassName("tb_element_cid_"+this.cid)[0].getElementsByClassName(this.type+"_inner")[0],m=!0===d?n:l.getAttribute("data-col_"+b),p=l.children,r=p.length,w=[];for(l=0;l<r;++l)w.push(c.Utils._getColClass(p[l].className.split(" ")));p="tb_rgrids"===a.id?a:h(a).find("#tb_rgrids")[0];for(l=6;-1<l;--l)p.classList.remove("col-count-"+l);p.classList.add("col-count-"+r);w="grid-layout-"+w.join("-");a=a.getElementsByClassName("tb_grid_"+
b)[0];p=a.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");m="-auto"!==m&&m?"grid-layout-"+m.replace(/column|tb_3col/ig,"").trim():!1;!1!==d||!1!==m&&1!==r||(m=b+"-auto");for(l=p.length-1;-1<l;--l)!0===d&&p[l].classList.contains(w)||!1===d&&p[l].classList.contains(m)?p[l].classList.add("selected"):p[l].classList.remove("selected");if("ltr"!==f)for(p=a.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),l=p.length-1;-1<l;--l)p[l].getAttribute("data-dir")===
f?p[l].classList.add("selected"):p[l].classList.remove("selected");if(!0===d){if("col_align_top"!==g||!0===C)for(b=a.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),l=b.length-1;-1<l;--l)b[l].getAttribute("data-alignment")===g?b[l].classList.add("selected"):b[l].classList.remove("selected");if("gutter-default"!==e)for(g=a.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")===e?g[l].classList.add("selected"):
g[l].classList.remove("selected");if(k)for(g=a.getElementsByClassName("tb_column_height")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")==k?g[l].classList.add("selected"):g[l].classList.remove("selected")}},setRowOptions(a){var b=null,d=c.activeModel,e=ThemifyConstructor.component,f=c.Models.Registry.lookup(this.cid),g=f.get("styling");g||(g={});null!==d&&(b="module"===c.activeModel.get("elType")?"mod_settings":"styling",b=c.activeModel.get(b));if(a.children[0]!==
n)for(;a.firstChild;)a.removeChild(a.firstChild);ThemifyConstructor.values=g;ThemifyConstructor.component=this.type;c.activeModel=f;a.appendChild(ThemifyConstructor.create(ThemifyConstructor.data.row.setting.options.slice(0,6)));ThemifyConstructor.values=b;c.activeModel=d;ThemifyConstructor.component=e},clear(){if(null!==this.type){this.cid=this.type=null;for(this.el.classList.remove("tb_show_toolbar");null!==this.el.firstChild;)this.el.removeChild(this.el.firstChild);if(null!==this.prevExpand&&this.prevExpand!==
n){for(;null!==this.prevExpand.firstChild;)this.prevExpand.removeChild(this.prevExpand.firstChild);this.prevExpand.removeAttribute("id");this.prevExpand.closest(".tb_action_wrap").classList.remove("tb_clicked");this.prevExpand=null}this.clearSelected();v.body[0].classList.remove("tb_action_active");v.body[0].classList.remove("tb_component_menu_active")}},clearSelected(){"visual"===c.mode&&c.EdgeDrag.clearEdges()},clearClicked(){for(var a=c.Instances.Builder[0].el.getElementsByClassName("tb_element_clicked"),
b=a.length-1;-1<b;--b)a[b].classList.remove("tb_element_clicked")},setPosition(a,b){a.removeAttribute("data-top");var d=a.getBoundingClientRect(),e=d.width;d=d.height+40;var f="visual"===c.mode?x.pageYOffset:c.toolbar.el.offsetTop+this.topH,g="visual"===c.mode?q.body:c.Instances.Builder[0].el,k=g.clientWidth;b=b.nodeType!==n?h(b).offset():b;b.right=b.bottom="";b.left-=parseFloat(e/2);b.top-=d;b.left+e>k?(b.left="auto",b.right=10):0>b.left&&(b.left=30);b.top>g.clientHeight?"visual"!==c.mode&&(b.top=
"auto",b.bottom=50):f>b.top&&(a.dataset.top=!0,b.top+=2*d-25,"visual"!==c.mode&&(b.top-=d/2));for(var l in b)a.style[l]="auto"!==b[l]&&""!==b[l]?b[l]+"px":b[l]}};c.Forms.register_validator=function(a,b){this.Validators[a]=b};c.Forms.get_validator=function(a){return this.Validators[a]!==n?this.Validators[a]:this.Validators.not_empty};c.Forms.register_validator("email",function(a){var b=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
a=a.split(",");for(var c=a.length-1;-1<c;--c)if(!b.test(a[c]))return!1;return!0});c.Forms.register_validator("not_empty",function(a){return!(!a||""===a.trim())});c.GS={styles:{},initContent:!1,loadingPosts:!1,allLoaded:!1,el:null,dropdown:null,isShown:null,field:null,isGSPage:q.body.classList.contains("gs_post"),activeGS:null,xhr:null,key:"global_styles",previousModel:null,liveInstance:null,init(){if(!0===this.isGSPage)if(r.document.body.classList.add("gs_post"),"visual"!==c.mode||!0===v.is_builder_loaded)this.openStylingPanel();
else{var a=this;r.Themify.body.one("themify_builder_ready",function(b){a.openStylingPanel();a=null})}else null!==themifyBuilder.globalStyles&&(this.extend(this.styles,themifyBuilder.globalStyles),themifyBuilder.globalStyles=null)},extend(a,b){for(var c in b)b[c]!==n&&(a[c]=b[c]);return a},openStylingPanel(){var a=function(){null===ThemifyConstructor.label&&(ThemifyConstructor.label=themifyBuilder.i18n.label);var b=themifyBuilder.globalStyleData.type;b=c.Models.Registry.lookup(c.Instances.Builder[c.builderIndex].el.getElementsByClassName(("row"===
b||"column"===b||"subrow"===b?"module_":"module-")+b)[0].dataset.cid);b.set("styleClicked",{silent:!0});c.isPreview=!1;b.trigger("edit",null);c.isPreview=!0;v.body.one("themify_builder_save_data",a)};a();c.toolbar.el.getElementsByClassName("tb_toolbar_builder_preview")[0].click()},setCss(a,b,d){"visual"===c.mode&&c.liveStylingInstance.setCss(a,b,d)},createCss(a,b,c){ThemifyStyles.GS={};return ThemifyStyles.createCss(a,b,c,this.styles)},findUsedItems(a){a=JSON.stringify(a);for(var b=/"global_styles":"(.*?)"/mg,
c,e="";null!==(c=b.exec(a));)e+=" "+c[1].trim();e=e.trim();if(""!==e){e=h.unique(e.split(" "));a=[];for(b=e.length-1;-1<b;--b)this.styles[e[b]]!==n&&a.push(e[b]);return a}return!1},globalStylesHTML(){if(!0===this.isGSPage||null!==this.activeGS)return!1;const a=q.createElement("div");var b=q.createElement("div");const d=q.createElement("span");this.isShown=null;this.field=ThemifyConstructor.hidden.render({id:c.GS.key,is_responsive:!1,value:ThemifyConstructor.values[c.GS.key],control:!1},ThemifyConstructor);
a.className="tb_gs_container";if(this.field.value){let a=this.field.value.split(" "),b="";for(let c=a.length-1;-1<c;--c)this.styles[a[c]]!==n&&(b+=" "+a[c]);b=b.trim();this.field.value=b}else this.field.value="";b.className="tb_gs_icon";b.addEventListener("click",function(a){if(a.target.classList.contains("tb_gs_icon")){const b=this.el;if(b.classList.contains("tb_gs_dropdown_opened"))a.stopPropagation(),b.classList.remove("tb_gs_dropdown_action","tb_gs_dropdown_opened");else{b.classList.add("tb_gs_dropdown_opened",
"tb_gs_dropdown_action");const a=function(d){null===b||b.contains(d.target)||(q.removeEventListener("click",a,{passive:!0}),"visual"===c.mode&&r.document.removeEventListener("click",a,{passive:!0}),b.classList.remove("tb_gs_dropdown_action","tb_gs_dropdown_opened"))};q.addEventListener("mousedown",a,{passive:!0});"visual"===c.mode&&r.document.addEventListener("mousedown",a,{passive:!0})}}}.bind(this),{passive:!0});d.className="tb_gs_tooltip";d.textContent=themifyBuilder.i18n.gs;b.appendChild(c.Utils.getIcon("ti-brush-alt"));
b.appendChild(d);a.appendChild(this.field);a.appendChild(b);this.el=a;""!==this.field.value&&(b=this.stylingOverlay(),null!==b&&a.appendChild(b));a.addEventListener("click",this.initClickEvent.bind(this));this.initContent=!1;return this.el},initHTML(){var a=q.createElement("div"),b=this.field.value.trim();if(""!==b){b=b.split(" ");for(let c=0,e=b.length;c<e;++c)this.styles[b[c]]!==n&&a.appendChild(this.createSelectedItem(b[c]))}a.className="tb_gs_selected_styles";this.el.appendChild(a);a=this.el.getElementsByClassName("tb_gs_icon")[0];
a.parentNode.insertBefore(q.getElementById("tmpl-global_styles").content.cloneNode(!0),a.nextSibling);this.initContent=!0},createSelectedItem(a){const b=this.styles[a],d=q.createElement("div"),e=q.createElement("span"),f=q.createElement("span"),g=q.createElement("span");d.className="tb_selected_style";d.dataset.styleId=a;g.className="tb_gs_edit";g.appendChild(c.Utils.getIcon("ti-pencil"));d.appendChild(g);e.innerText=b.title;d.appendChild(e);f.className="tb_delete_gs tf_close";d.appendChild(f);return d},
saveAs(){const a=this;m.LiteLightbox.prompt(themifyBuilder.i18n.enterGlobalStyleName,function(b){if(null!==b){if(""===b)return alert(themifyBuilder.i18n.enterGlobalStyleName),a.saveAs(),!1;a.saveAsCallback(b)}})},saveAsCallback(a){ThemifyConstructor.setStylingValues(c.activeBreakPoint);let b=c.activeModel.get("elType");const d=this,e=c.Utils.clear(ThemifyConstructor.values);"module"===b&&(b=c.activeModel.get("mod_name"));delete e[this.key];h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",
data:{action:"tb_save_as_new_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,type:b,styles:e,title:a},beforeSend(){m.showLoader("show")},error(){m.showLoader("error")},success(a){m.showLoader("hide");"success"===a.status?(a=a.post_data,d.styles[a.class]=a,c.Utils.saveCss(c.Utils.clear(a.data),"",a.id),m.LiteLightbox.confirm(themifyBuilder.i18n.addSavedGS,function(b){if("yes"===b){d.isGSPage=!0;b=d.field.value;m.Lightbox.$lightbox[0].getElementsByClassName("reset-styling")[0].click();d.isGSPage=
!1;b=a.class+" "+b;b=b.trim();d.field.value=b;b=b.split(" ");const e=d.el.getElementsByClassName("tb_gs_selected_styles")[0];e.innerHTML="";for(let a=0,c=b.length;a<c;++a)e.appendChild(d.createSelectedItem(b[a]));c.GS.generateValues(null,b,!0);b=d.stylingOverlay();null!==b&&d.el.appendChild(b)}d.addItemToDropdown([a.class])},{buttons:{no:{label:ThemifyConstructor.label.no},yes:{label:ThemifyConstructor.label.y}}})):alert(a.msg)}})},delete(a){if(null!==this.field){c.hasChanged=!0;var b=this.el.querySelector('.global_style_item[data-style-id="'+
...
q.createDocumentFragment(),c=this.field.value.split(" "),e=this.dropdown.getElementsByClassName("tb_no_gs_item")[0];for(let d=0,e=a.length;d<e;++d){let e=this.styles[a[d]],f=q.createElement("div"),g=q.createElement("span"),h=q.createElement("span");f.className="global_style_item";f.className+=-1!==c.indexOf(a[d])?" selected":"";f.dataset.styleId=a[d];h.className="global_style_title";h.innerText=e.title;g.className="global_style_type";g.innerText=e.type;f.appendChild(h);f.appendChild(g);b.appendChild(f)}e.parentNode.insertBefore(b,
...
ThemifyStyles.disableNestedSel=!0;null===this.liveInstance&&(this.liveInstance=c.createStyleInstance(),this.liveInstance.init(!0,!0));e=this.createCss([f],e);var g=this.liveInstance,h=[],l=c.activeBreakPoint,m=g.prefix,p=new RegExp(m,"g");ThemifyStyles.disableNestedSel=null;if(!0===d){d=ThemifyConstructor.breakpointsReverse;for(var n=d.length-1;-1<n;--n){c.activeBreakPoint=d[n];g.setMode(d[n],!0);var q=g.currentSheet;q=q.cssRules?q.cssRules:q.rules;for(var r=q.length-1;-1<r;--r)if(-1!==q[r].selectorText.indexOf(m)){let a=
q[r].selectorText.replace(/,\s+/g,",").replace(p,"").split(","),b=q[r].cssText.split("{")[1].split(";");if(-1!==a[0].indexOf(".tb_text_wrap"))for(var v=a.length-1;0<v;--v)-1!==a[v].indexOf(".tb_text_wrap")&&a.splice(v,1);for(v=b.length-2;-1<v;--v)g.setLiveStyle(b[v].trim().split(": ")[0].trim(),"",a)}}}delete e.gs;for(let a in e)if("fonts"===a||"cf_fonts"===a)for(let b in e[a])m=b,0<e[a][b].length&&(m+=":"+e[a][b].join(",")),h.push(m);else{c.activeBreakPoint=a;g.setMode(a,!0);for(let b in e[a]){m=
b.replace(/,\s+/g,",").replace(p,"").split(",");for(let c=0,f=e[a][b].length;c<f;++c)for(d=e[a][b][c].split(";"),n=d.length-2;-1<n;--n)""!==d[n]&&(q=d[n].split(":")[0],r=d[n].replace(q+":","").trim(),"background-image"===q&&-1!==d[n].indexOf("svg")&&-1!==d[n].indexOf("data:")&&(r+=";"+d[n+1]),g.setLiveStyle(q,r,m))}}0<h.length&&ThemifyConstructor.font_select.loadGoogleFonts(h.join("|"));c.activeBreakPoint=l;this.updated(a,e,f,b);this.liveInstance=null}},extraStyle(a,b,d){var e=null!==this.liveInstance?
this.liveInstance:c.liveStylingInstance,f=e.prefix.length-1,g=0!==e.getComponentBgOverlay().length;d=e.$liveStyledElmt;var h=g,l={top:!1,bottom:!1,left:!1,right:!1},m=0;a:for(var p in a)if("fonts"!==p&&"cf_fonts"!==p&&"gs"!==p)for(let b in a[p]){!1===h&&(h=-1!==b.indexOf("builder_row_cover",f));if(-1!==b.indexOf("tb_row_frame",f))for(let a in l)if(!1===l[a]&&-1!==b.indexOf("tb_row_frame_"+a,f)){l[a]=!0;++m;break}if(!0===h&&4===m)break a}!1===g&&!0===h&&e.addOrRemoveComponentOverlay();if(0<m){a=q.createDocumentFragment();
for(var r in l)!0===l[r]&&0===d.children(".tb_row_frame_"+r).length&&(p=q.createElement("div"),p.className="tf_abs tb_row_frame tb_row_frame_"+r,a.appendChild(p));d.children(".tb_action_wrap").after(a)}(r=b.styling!==n?b.styling.background_type:"none")||(r="image");"image"===r&&"builder-parallax-scrolling"===b.styling.background_repeat&&b.styling.background_image?(d[0].classList.add("builder-parallax-scrolling"),ThemifyBuilderModuleJs.backgroundScrolling(d)):(d[0].classList.remove("builder-parallax-scrolling"),
...
k[b].get("styling");d[g.key]!==n&&""!==d[g.key]&&-1!==d[g.key].indexOf(a)&&(c.activeModel=k[b],g.generateValues(a,d[g.key].split(" "),!0))}g.liveInstance=null}c.activeModel=l;g.previousModel=f;u(!0);c.hasChanged=!1;h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_update_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,data:e.data,id:e.id},error(){m.showLoader("error")},success(){b||d?g.previousModel=null:g.reopenPreviousPanel();m.showLoader("hide")}})})},reopenPreviousPanel(a){n!==
a?a.model.trigger("edit",a.e,a.target):null!==this.previousModel&&(a=c.Models.Registry.lookup(this.previousModel),null!==a&&(a.set({styleClicked:!0},{silent:!0}),a.trigger("edit",null)),this.previousModel=null)},stylingOverlay(){if(null===this.isShown&&null!==c.activeModel&&(null===this.el.parentNode||!this.el.parentNode.classList.contains("tb_inline_gs_show"))){this.isShown=!0;const a=q.createElement("div"),b=q.createElement("p");a.className="tb_gs_options_overlay";b.textContent=themifyBuilder.i18n.has_gs;
